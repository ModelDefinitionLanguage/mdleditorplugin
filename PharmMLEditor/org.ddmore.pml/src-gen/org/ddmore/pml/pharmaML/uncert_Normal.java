 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.uncert_Normal#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.uncert_Normal#getMean <em>Mean</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.uncert_Normal#getStdDev <em>Std Dev</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.uncert_Normal#getVariance <em>Variance</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.uncert_Normal#getCoefficientOfVariance <em>Coefficient Of Variance</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal()
 * @model
 * @generated
 */
public interface uncert_Normal extends EObject
{
   ...
   * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal_Xmlns()
   ...
   * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal_Mean()
   * @model containment="true"
   * @generated
   */
  uncert_Mean getMean();
  ...
  /**
   * Sets the value of the '{@link org.ddmore.pml.pharmaML.uncert_Normal#getMean <em>Mean</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal_StdDev()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ddmore.pml.pharmaML.uncert_Normal#getStdDev <em>Std Dev</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal_Variance()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ddmore.pml.pharmaML.uncert_Normal#getVariance <em>Variance</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.ddmore.pml.pharmaML.PharmaMLPackage#getuncert_Normal_CoefficientOfVariance()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.ddmore.pml.pharmaML.uncert_Normal#getCoefficientOfVariance <em>Coefficient Of Variance</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
