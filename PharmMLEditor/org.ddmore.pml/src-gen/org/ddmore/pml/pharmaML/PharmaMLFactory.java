 ...
 * @generated
 */
public interface PharmaMLFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  PharmaMLFactory eINSTANCE = org.ddmore.pml.pharmaML.impl.PharmaMLFactoryImpl.init();

  /**
   * Returns a new object of class '<em>Mml Pharma ML</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Mml Pharma ML</em>'.
   * @generated
   */
  Mml_PharmaML createMml_PharmaML();
  ...
  /**
   * Returns a new object of class '<em>mdef Continuous Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>mdef Continuous Type</em>'.
   * @generated
   */
  mdef_ContinuousType createmdef_ContinuousType();
  ...
  /**
   * Returns a new object of class '<em>msteps Mapping Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>msteps Mapping Type</em>'.
   * @generated
   */
  msteps_MappingType createmsteps_MappingType();
  ...
  /**
   * Returns a new object of class '<em>ct Int Value</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ct Int Value</em>'.
   * @generated
   */
  ct_Int_Value createct_Int_Value();
  ...
  /**
   * Returns a new object of class '<em>ct Variable Assignment Type</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ct Variable Assignment Type</em>'.
   * @generated
   */
  ct_VariableAssignmentType createct_VariableAssignmentType();
  ...
  /**
   * Returns a new object of class '<em>ct xmlns</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ct xmlns</em>'.
   * @generated
   */
  ct_xmlns createct_xmlns();
   ...
   * @generated
   */
  PharmaMLPackage getPharmaMLPackage();
