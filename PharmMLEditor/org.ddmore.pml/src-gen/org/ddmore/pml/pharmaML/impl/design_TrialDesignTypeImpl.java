 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_TrialDesignTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_TrialDesignTypeImpl#getTreatment <em>Treatment</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_TrialDesignTypeImpl#getTreatmentEpoch <em>Treatment Epoch</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_TrialDesignTypeImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class design_TrialDesignTypeImpl extends MinimalEObjectImpl.Container implements design_TrialDesignType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getdesign_TrialDesignType();
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public EList<design_TreatmentType> getTreatment()
  {
    if (treatment == null)
    {
      treatment = new EObjectContainmentEList<design_TreatmentType>(design_TreatmentType.class, this, PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__TREATMENT);
    }
    return treatment;
  }
  ...
  public EList<design_TreatmentEpohType> getTreatmentEpoch()
  {
    ...
    {
      treatmentEpoch = new EObjectContainmentEList<design_TreatmentEpohType>(design_TreatmentEpohType.class, this, PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__TREATMENT_EPOCH);
    }
  ...
  public EList<design_GroupType> getGroup()
  {
    if (group == null)
    {
      group = new EObjectContainmentEList<design_GroupType>(design_GroupType.class, this, PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__GROUP);
    }
    return group;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__TREATMENT:
        return ((InternalEList<?>)getTreatment()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__TREATMENT_EPOCH:
        return ((InternalEList<?>)getTreatmentEpoch()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.DESIGN_TRIAL_DESIGN_TYPE__GROUP:
