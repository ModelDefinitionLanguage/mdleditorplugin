 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_StepTypeImpl#getIdRef <em>Id Ref</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_StepTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_StepTypeImpl#getDependantStep <em>Dependant Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class msteps_StepTypeImpl extends MinimalEObjectImpl.Container implements msteps_StepType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getmsteps_StepType();
  }
  ...
  public void setIdRef(String newIdRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_STEP_TYPE__ID_REF, oldIdRef, idRef));
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.MSTEPS_STEP_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public EList<msteps_DependantStepType> getDependantStep()
  {
    ...
    {
      dependantStep = new EObjectContainmentEList<msteps_DependantStepType>(msteps_DependantStepType.class, this, PharmaMLPackage.MSTEPS_STEP_TYPE__DEPENDANT_STEP);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MSTEPS_STEP_TYPE__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.MSTEPS_STEP_TYPE__DEPENDANT_STEP:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MSTEPS_STEP_TYPE__ID_REF:
        return getIdRef();
      case PharmaMLPackage.MSTEPS_STEP_TYPE__XMLNS:
        return getXmlns();
      case PharmaMLPackage.MSTEPS_STEP_TYPE__DEPENDANT_STEP:
