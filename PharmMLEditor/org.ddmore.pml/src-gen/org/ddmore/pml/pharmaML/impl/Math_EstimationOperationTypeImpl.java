 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_EstimationOperationTypeImpl#getEstPop <em>Est Pop</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_EstimationOperationTypeImpl#getEstFIM <em>Est FIM</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_EstimationOperationTypeImpl#getEstIndiv <em>Est Indiv</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_EstimationOperationTypeImpl extends MinimalEObjectImpl.Container implements Math_EstimationOperationType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_EstimationOperationType();
  }
  ...
  public void setEstPop(String newEstPop)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_POP, oldEstPop, estPop));
  }
  ...
  public void setEstFIM(String newEstFIM)
  {
    ...
    estFIM = newEstFIM;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_FIM, oldEstFIM, estFIM));
  }
  ...
  public void setEstIndiv(String newEstIndiv)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_INDIV, oldEstIndiv, estIndiv));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_POP:
        return getEstPop();
      case PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_FIM:
        return getEstFIM();
      case PharmaMLPackage.MATH_ESTIMATION_OPERATION_TYPE__EST_INDIV:
        return getEstIndiv();
    }
