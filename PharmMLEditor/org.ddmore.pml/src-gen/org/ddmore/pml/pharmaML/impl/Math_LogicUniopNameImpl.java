 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicUniopNameImpl#getIsDefined <em>Is Defined</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicUniopNameImpl#getNot <em>Not</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_LogicUniopNameImpl extends MinimalEObjectImpl.Container implements Math_LogicUniopName
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_LogicUniopName();
  }
  ...
  public void setIsDefined(String newIsDefined)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_UNIOP_NAME__IS_DEFINED, oldIsDefined, isDefined));
  }
  ...
  public void setNot(String newNot)
  {
    ...
    not = newNot;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_UNIOP_NAME__NOT, oldNot, not));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_LOGIC_UNIOP_NAME__IS_DEFINED:
        return getIsDefined();
      case PharmaMLPackage.MATH_LOGIC_UNIOP_NAME__NOT:
        return getNot();
    }
