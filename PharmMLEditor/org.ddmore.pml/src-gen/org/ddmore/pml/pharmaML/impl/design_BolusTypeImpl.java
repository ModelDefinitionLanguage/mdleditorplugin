 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_BolusTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_BolusTypeImpl#getDoseAmount <em>Dose Amount</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_BolusTypeImpl#getSteadyState <em>Steady State</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.design_BolusTypeImpl#getDosingTimes <em>Dosing Times</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class design_BolusTypeImpl extends MinimalEObjectImpl.Container implements design_BolusType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getdesign_BolusType();
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.DESIGN_BOLUS_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public NotificationChain basicSetDoseAmount(design_DoseAmountType newDoseAmount, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSE_AMOUNT, oldDoseAmount, newDoseAmount);
  ...
  public void setDoseAmount(design_DoseAmountType newDoseAmount)
  {
    if (newDoseAmount != doseAmount)
    {
      ...
      if (doseAmount != null)
        msgs = ((InternalEObject)doseAmount).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSE_AMOUNT, null, msgs);
      if (newDoseAmount != null)
        msgs = ((InternalEObject)newDoseAmount).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSE_AMOUNT, null, msgs);
      msgs = basicSetDoseAmount(newDoseAmount, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSE_AMOUNT, newDoseAmount, newDoseAmount));
  }
  ...
  public NotificationChain basicSetSteadyState(design_SteadyStateType newSteadyState, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__STEADY_STATE, oldSteadyState, newSteadyState);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSteadyState(design_SteadyStateType newSteadyState)
  {
    if (newSteadyState != steadyState)
    {
      NotificationChain msgs = null;
      if (steadyState != null)
        msgs = ((InternalEObject)steadyState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__STEADY_STATE, null, msgs);
      if (newSteadyState != null)
        msgs = ((InternalEObject)newSteadyState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__STEADY_STATE, null, msgs);
      msgs = basicSetSteadyState(newSteadyState, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__STEADY_STATE, newSteadyState, newSteadyState));
  }
  ...
  public NotificationChain basicSetDosingTimes(design_DosingTimesType newDosingTimes, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSING_TIMES, oldDosingTimes, newDosingTimes);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDosingTimes(design_DosingTimesType newDosingTimes)
  {
    if (newDosingTimes != dosingTimes)
    {
      NotificationChain msgs = null;
      if (dosingTimes != null)
        msgs = ((InternalEObject)dosingTimes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSING_TIMES, null, msgs);
      if (newDosingTimes != null)
        msgs = ((InternalEObject)newDosingTimes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSING_TIMES, null, msgs);
      msgs = basicSetDosingTimes(newDosingTimes, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSING_TIMES, newDosingTimes, newDosingTimes));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.DESIGN_BOLUS_TYPE__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSE_AMOUNT:
        return basicSetDoseAmount(null, msgs);
      case PharmaMLPackage.DESIGN_BOLUS_TYPE__STEADY_STATE:
        return basicSetSteadyState(null, msgs);
      case PharmaMLPackage.DESIGN_BOLUS_TYPE__DOSING_TIMES:
