 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getBinopName <em>Binop Name</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getMinus <em>Minus</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getTimes <em>Times</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getDivide <em>Divide</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getPower <em>Power</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getLog <em>Log</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_BinopNameImpl#getRoot <em>Root</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
{
  /**
   * The default value of the '{@link #getBinopName() <em>Binop Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getBinopName()
   * @generated
   * @ordered
   */
  protected static final String BINOP_NAME_EDEFAULT = null;

  /**
   * The cached value of the '{@link #getBinopName() <em>Binop Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getBinopName()
   * @generated
   * @ordered
   */
  protected String binopName = BINOP_NAME_EDEFAULT;
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_BinopName();
  }
  ...
  public void setBinopName(String newBinopName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__BINOP_NAME, oldBinopName, binopName));
  }
  ...
  public void setMinus(String newMinus)
  {
    ...
    minus = newMinus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__MINUS, oldMinus, minus));
  }
  ...
  public void setTimes(String newTimes)
  {
    ...
    times = newTimes;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__TIMES, oldTimes, times));
  }
  ...
  public void setDivide(String newDivide)
  {
    ...
    divide = newDivide;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__DIVIDE, oldDivide, divide));
  }
  ...
  public void setPower(String newPower)
  {
    ...
    power = newPower;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__POWER, oldPower, power));
  }
  ...
  public void setLog(String newLog)
  {
    ...
    log = newLog;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__LOG, oldLog, log));
  }
  ...
  public void setRoot(String newRoot)
  {
    ...
    root = newRoot;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_BINOP_NAME__ROOT, oldRoot, root));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_BINOP_NAME__BINOP_NAME:
        return getBinopName();
      case PharmaMLPackage.MATH_BINOP_NAME__MINUS:
        return getMinus();
      case PharmaMLPackage.MATH_BINOP_NAME__TIMES:
        return getTimes();
      case PharmaMLPackage.MATH_BINOP_NAME__DIVIDE:
        return getDivide();
      case PharmaMLPackage.MATH_BINOP_NAME__POWER:
        return getPower();
      case PharmaMLPackage.MATH_BINOP_NAME__LOG:
        return getLog();
      case PharmaMLPackage.MATH_BINOP_NAME__ROOT:
        return getRoot();
    }
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case PharmaMLPackage.MATH_BINOP_NAME__BINOP_NAME:
        setBinopName(BINOP_NAME_EDEFAULT);
        return;
      case PharmaMLPackage.MATH_BINOP_NAME__MINUS:
  ...
  public boolean eIsSet(int featureID)
  {
    ...
    {
      case PharmaMLPackage.MATH_BINOP_NAME__BINOP_NAME:
        return BINOP_NAME_EDEFAULT == null ? binopName != null : !BINOP_NAME_EDEFAULT.equals(binopName);
      case PharmaMLPackage.MATH_BINOP_NAME__MINUS:
