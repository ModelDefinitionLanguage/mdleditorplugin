 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getInitialValue <em>Initial Value</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getObjectiveDataSet <em>Objective Data Set</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getParametersToEstimate <em>Parameters To Estimate</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.msteps_EstimationStepImpl#getEstimationOperation <em>Estimation Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class msteps_EstimationStepImpl extends MinimalEObjectImpl.Container implements msteps_EstimationStep
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getmsteps_EstimationStep();
  }
  ...
  public NotificationChain basicSetId(ct_id newId, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ID, oldId, newId);
  ...
  public void setId(ct_id newId)
  {
    if (newId != id)
    {
      ...
      if (id != null)
        msgs = ((InternalEObject)id).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ID, null, msgs);
      if (newId != null)
        msgs = ((InternalEObject)newId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ID, null, msgs);
      msgs = basicSetId(newId, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ID, newId, newId));
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__XMLNS);
    }
    return xmlns;
  }
  ...
  public NotificationChain basicSetDescription(ct_AnnotationType newDescription, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__DESCRIPTION, oldDescription, newDescription);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDescription(ct_AnnotationType newDescription)
  {
    if (newDescription != description)
    {
      NotificationChain msgs = null;
      if (description != null)
        msgs = ((InternalEObject)description).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__DESCRIPTION, null, msgs);
      if (newDescription != null)
        msgs = ((InternalEObject)newDescription).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__DESCRIPTION, null, msgs);
      msgs = basicSetDescription(newDescription, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__DESCRIPTION, newDescription, newDescription));
  }
  ...
  public EList<msteps_InitialValueType> getInitialValue()
  {
    ...
    {
      initialValue = new EObjectContainmentEList<msteps_InitialValueType>(msteps_InitialValueType.class, this, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__INITIAL_VALUE);
    }
    return initialValue;
  }
  ...
  public NotificationChain basicSetObjectiveDataSet(msteps_ObjectiveDataSetType newObjectiveDataSet, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__OBJECTIVE_DATA_SET, oldObjectiveDataSet, newObjectiveDataSet);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setObjectiveDataSet(msteps_ObjectiveDataSetType newObjectiveDataSet)
  {
    if (newObjectiveDataSet != objectiveDataSet)
    {
      ...
      if (objectiveDataSet != null)
        msgs = ((InternalEObject)objectiveDataSet).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__OBJECTIVE_DATA_SET, null, msgs);
      if (newObjectiveDataSet != null)
        msgs = ((InternalEObject)newObjectiveDataSet).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__OBJECTIVE_DATA_SET, null, msgs);
      msgs = basicSetObjectiveDataSet(newObjectiveDataSet, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__OBJECTIVE_DATA_SET, newObjectiveDataSet, newObjectiveDataSet));
  }
  ...
  public NotificationChain basicSetParametersToEstimate(msteps_ParametersToEstimateType newParametersToEstimate, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__PARAMETERS_TO_ESTIMATE, oldParametersToEstimate, newParametersToEstimate);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParametersToEstimate(msteps_ParametersToEstimateType newParametersToEstimate)
  {
    if (newParametersToEstimate != parametersToEstimate)
    {
      ...
      if (parametersToEstimate != null)
        msgs = ((InternalEObject)parametersToEstimate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__PARAMETERS_TO_ESTIMATE, null, msgs);
      if (newParametersToEstimate != null)
        msgs = ((InternalEObject)newParametersToEstimate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.MSTEPS_ESTIMATION_STEP__PARAMETERS_TO_ESTIMATE, null, msgs);
      msgs = basicSetParametersToEstimate(newParametersToEstimate, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__PARAMETERS_TO_ESTIMATE, newParametersToEstimate, newParametersToEstimate));
  }
  ...
  public EList<msteps_EstimationOperationType> getEstimationOperation()
  {
    ...
    {
      estimationOperation = new EObjectContainmentEList<msteps_EstimationOperationType>(msteps_EstimationOperationType.class, this, PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ESTIMATION_OPERATION);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ID:
        return basicSetId(null, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__DESCRIPTION:
        return basicSetDescription(null, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__INITIAL_VALUE:
        return ((InternalEList<?>)getInitialValue()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__OBJECTIVE_DATA_SET:
        return basicSetObjectiveDataSet(null, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__PARAMETERS_TO_ESTIMATE:
        return basicSetParametersToEstimate(null, msgs);
      case PharmaMLPackage.MSTEPS_ESTIMATION_STEP__ESTIMATION_OPERATION:
