 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.uncert_PDFImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.uncert_PDFImpl#getFunctionParameter <em>Function Parameter</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.uncert_PDFImpl#getEquation <em>Equation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class uncert_PDFImpl extends MinimalEObjectImpl.Container implements uncert_PDF
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getuncert_PDF();
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.UNCERT_PDF__XMLNS);
    }
    return xmlns;
  }
  ...
  public EList<uncert_ParameterDefinitionType> getFunctionParameter()
  {
    ...
    {
      functionParameter = new EObjectContainmentEList<uncert_ParameterDefinitionType>(uncert_ParameterDefinitionType.class, this, PharmaMLPackage.UNCERT_PDF__FUNCTION_PARAMETER);
    }
  ...
  public NotificationChain basicSetEquation(Math_EquationType newEquation, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.UNCERT_PDF__EQUATION, oldEquation, newEquation);
  ...
  public void setEquation(Math_EquationType newEquation)
  {
    if (newEquation != equation)
    {
      ...
      if (equation != null)
        msgs = ((InternalEObject)equation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.UNCERT_PDF__EQUATION, null, msgs);
      if (newEquation != null)
        msgs = ((InternalEObject)newEquation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.UNCERT_PDF__EQUATION, null, msgs);
      msgs = basicSetEquation(newEquation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.UNCERT_PDF__EQUATION, newEquation, newEquation));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.UNCERT_PDF__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.UNCERT_PDF__FUNCTION_PARAMETER:
        return ((InternalEList<?>)getFunctionParameter()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.UNCERT_PDF__EQUATION:
