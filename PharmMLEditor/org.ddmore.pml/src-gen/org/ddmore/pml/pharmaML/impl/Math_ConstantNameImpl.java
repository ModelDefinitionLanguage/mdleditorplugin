 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_ConstantNameImpl#getNotanumber <em>Notanumber</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_ConstantNameImpl#getPi <em>Pi</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_ConstantNameImpl#getExponentiale <em>Exponentiale</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_ConstantNameImpl#getInfinity <em>Infinity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_ConstantNameImpl extends MinimalEObjectImpl.Container implements Math_ConstantName
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_ConstantName();
  }
  ...
  public void setNotanumber(String newNotanumber)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_CONSTANT_NAME__NOTANUMBER, oldNotanumber, notanumber));
  }
  ...
  public void setPi(String newPi)
  {
    ...
    pi = newPi;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_CONSTANT_NAME__PI, oldPi, pi));
  }
  ...
  public void setExponentiale(String newExponentiale)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_CONSTANT_NAME__EXPONENTIALE, oldExponentiale, exponentiale));
  }
  ...
  public void setInfinity(String newInfinity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_CONSTANT_NAME__INFINITY, oldInfinity, infinity));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_CONSTANT_NAME__NOTANUMBER:
        return getNotanumber();
      case PharmaMLPackage.MATH_CONSTANT_NAME__PI:
        return getPi();
      case PharmaMLPackage.MATH_CONSTANT_NAME__EXPONENTIALE:
        return getExponentiale();
      case PharmaMLPackage.MATH_CONSTANT_NAME__INFINITY:
        return getInfinity();
    }
