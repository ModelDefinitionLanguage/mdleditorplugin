 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_levelIdImpl#getLevelId <em>Level Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_levelIdImpl extends MinimalEObjectImpl.Container implements ct_levelId
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getct_levelId();
  }
  ...
  public void setLevelId(String newLevelId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.CT_LEVEL_ID__LEVEL_ID, oldLevelId, levelId));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.CT_LEVEL_ID__LEVEL_ID:
        return getLevelId();
    }
