 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.mdef_ImportResourceTypeTypeImpl#getSbml <em>Sbml</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.mdef_ImportResourceTypeTypeImpl#getPharmml <em>Pharmml</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class mdef_ImportResourceTypeTypeImpl extends MinimalEObjectImpl.Container implements mdef_ImportResourceTypeType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getmdef_ImportResourceTypeType();
  }
  ...
  public void setSbml(String newSbml)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MDEF_IMPORT_RESOURCE_TYPE_TYPE__SBML, oldSbml, sbml));
  }
  ...
  public void setPharmml(String newPharmml)
  {
    ...
    pharmml = newPharmml;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MDEF_IMPORT_RESOURCE_TYPE_TYPE__PHARMML, oldPharmml, pharmml));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MDEF_IMPORT_RESOURCE_TYPE_TYPE__SBML:
        return getSbml();
      case PharmaMLPackage.MDEF_IMPORT_RESOURCE_TYPE_TYPE__PHARMML:
        return getPharmml();
    }
