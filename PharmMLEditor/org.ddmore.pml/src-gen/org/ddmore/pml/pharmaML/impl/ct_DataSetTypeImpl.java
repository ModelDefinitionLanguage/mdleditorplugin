 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_DataSetTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_DataSetTypeImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_DataSetTypeImpl#getExternalSource <em>External Source</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_DataSetTypeImpl#getRow <em>Row</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.ct_DataSetTypeImpl#getInternalSource <em>Internal Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_DataSetTypeImpl extends MinimalEObjectImpl.Container implements ct_DataSetType
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getct_DataSetType();
  }
  ...
  public EList<ct_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<ct_xmlns>(ct_xmlns.class, this, PharmaMLPackage.CT_DATA_SET_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public NotificationChain basicSetDefinition(ct_DefinitionType newDefinition, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmaMLPackage.CT_DATA_SET_TYPE__DEFINITION, oldDefinition, newDefinition);
  ...
  public void setDefinition(ct_DefinitionType newDefinition)
  {
    if (newDefinition != definition)
    {
      ...
      if (definition != null)
        msgs = ((InternalEObject)definition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.CT_DATA_SET_TYPE__DEFINITION, null, msgs);
      if (newDefinition != null)
        msgs = ((InternalEObject)newDefinition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmaMLPackage.CT_DATA_SET_TYPE__DEFINITION, null, msgs);
      msgs = basicSetDefinition(newDefinition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.CT_DATA_SET_TYPE__DEFINITION, newDefinition, newDefinition));
  }
  ...
  public EList<ct_ExternalSourceType> getExternalSource()
  {
    ...
    {
      externalSource = new EObjectContainmentEList<ct_ExternalSourceType>(ct_ExternalSourceType.class, this, PharmaMLPackage.CT_DATA_SET_TYPE__EXTERNAL_SOURCE);
    }
  ...
  public EList<ct_RowType> getRow()
  {
    if (row == null)
    {
      row = new EObjectContainmentEList<ct_RowType>(ct_RowType.class, this, PharmaMLPackage.CT_DATA_SET_TYPE__ROW);
    }
    return row;
  }
  ...
  public EList<ct_InternalSourceType> getInternalSource()
  {
    ...
    {
      internalSource = new EObjectContainmentEList<ct_InternalSourceType>(ct_InternalSourceType.class, this, PharmaMLPackage.CT_DATA_SET_TYPE__INTERNAL_SOURCE);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmaMLPackage.CT_DATA_SET_TYPE__XMLNS:
        return ((InternalEList<?>)getXmlns()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.CT_DATA_SET_TYPE__DEFINITION:
        return basicSetDefinition(null, msgs);
      case PharmaMLPackage.CT_DATA_SET_TYPE__EXTERNAL_SOURCE:
        return ((InternalEList<?>)getExternalSource()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.CT_DATA_SET_TYPE__ROW:
        return ((InternalEList<?>)getRow()).basicRemove(otherEnd, msgs);
      case PharmaMLPackage.CT_DATA_SET_TYPE__INTERNAL_SOURCE:
