 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getLt <em>Lt</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getLeq <em>Leq</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getGt <em>Gt</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getGeq <em>Geq</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getEq <em>Eq</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getNeq <em>Neq</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getAnd <em>And</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getOr <em>Or</em>}</li>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_LogicBinopNameImpl#getXor <em>Xor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_LogicBinopNameImpl extends MinimalEObjectImpl.Container implements Math_LogicBinopName
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_LogicBinopName();
  }
  ...
  public void setLt(String newLt)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__LT, oldLt, lt));
  }
  ...
  public void setLeq(String newLeq)
  {
    ...
    leq = newLeq;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__LEQ, oldLeq, leq));
  }
  ...
  public void setGt(String newGt)
  {
    ...
    gt = newGt;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__GT, oldGt, gt));
  }
  ...
  public void setGeq(String newGeq)
  {
    ...
    geq = newGeq;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__GEQ, oldGeq, geq));
  }
  ...
  public void setEq(String newEq)
  {
    ...
    eq = newEq;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__EQ, oldEq, eq));
  }
  ...
  public void setNeq(String newNeq)
  {
    ...
    neq = newNeq;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__NEQ, oldNeq, neq));
  }
  ...
  public void setAnd(String newAnd)
  {
    ...
    and = newAnd;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__AND, oldAnd, and));
  }
  ...
  public void setOr(String newOr)
  {
    ...
    or = newOr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__OR, oldOr, or));
  }
  ...
  public void setXor(String newXor)
  {
    ...
    xor = newXor;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_LOGIC_BINOP_NAME__XOR, oldXor, xor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__LT:
        return getLt();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__LEQ:
        return getLeq();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__GT:
        return getGt();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__GEQ:
        return getGeq();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__EQ:
        return getEq();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__NEQ:
        return getNeq();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__AND:
        return getAnd();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__OR:
        return getOr();
      case PharmaMLPackage.MATH_LOGIC_BINOP_NAME__XOR:
        return getXor();
    }
