 ...
 * <ul>
 *   <li>{@link org.ddmore.pml.pharmaML.impl.Math_TRUEImpl#getTrue <em>True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_TRUEImpl extends MinimalEObjectImpl.Container implements Math_TRUE
{
  ...
  {
    return PharmaMLPackage.eINSTANCE.getMath_TRUE();
  }
  ...
  public void setTrue(String newTrue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmaMLPackage.MATH_TRUE__TRUE, oldTrue, true_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmaMLPackage.MATH_TRUE__TRUE:
        return getTrue();
    }
