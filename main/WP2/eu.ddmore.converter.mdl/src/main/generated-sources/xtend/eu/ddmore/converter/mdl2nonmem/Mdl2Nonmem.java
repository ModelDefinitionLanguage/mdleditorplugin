...
public class Mdl2Nonmem extends MdlPrinter {
  protected final String TARGET = "NMTRAN_CODE";
  ...
  public CharSequence convertToNMTRAN(final Mcl m) {
    CharSequence _xblockexpression = null;
    {
      ...
      CharSequence _printSIZES = this.printSIZES();
      _builder.append(_printSIZES, "");
      _builder.newLineIfNotEmpty();
      CharSequence _printPROB = this.printPROB();
      ...
      CharSequence _printABBREVIATED = this.printABBREVIATED();
      ...
      CharSequence _printAES = this.printAES();
  ...
  public CharSequence printSIZES() {
    StringConcatenation _builder = new StringConcatenation();
    {
  ...
  public CharSequence printABBREVIATED() {
    StringConcatenation _builder = new StringConcatenation();
    {
      boolean _or = false;
              ...
              for(final GroupVariablesBlockStatement st : _statements) {
                {
                  ...
                  if (_notEquals_1) {
                    ...
                    String _print = this.print(_statement_1);
          ...
          if (_notEquals) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              if (_greaterThan) {
                ...
                _builder.newLineIfNotEmpty();
                final String file = this.getTaskObjectName();
                _builder.newLineIfNotEmpty();
