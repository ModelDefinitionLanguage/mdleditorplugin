...
public class MdlPrinter {
  ...
  public void setLevelVars(final ModelObject o) {
    HashSet<String> tmp = this.getLevelVars(o, "1");
    for (final String v : tmp) {
      Object _get = this.level_vars.get(v);
      boolean _equals = Objects.equal(_get, null);
      if (_equals) {
        this.level_vars.put(v, "1");
      }
    }
    HashSet<String> _levelVars = this.getLevelVars(o, "2");
    tmp = _levelVars;
    for (final String v_1 : tmp) {
      Object _get_1 = this.level_vars.get(v_1);
      boolean _equals_1 = Objects.equal(_get_1, null);
      if (_equals_1) {
        this.level_vars.put(v_1, "2");
      }
    }
  }
  
  protected HashSet<String> getLevelVars(final ModelObject o, final String levelId) {
    HashSet<String> _hashSet = new HashSet<String>();
    HashSet<String> levelVars = _hashSet;
    EList<ModelObjectBlock> _blocks = o.getBlocks();
    for (final ModelObjectBlock b : _blocks) {
        ...
        for (final SymbolDeclaration s : _variables) {
          ...
          if (_notEquals_1) {
            ...
            if (_notEquals_2) {
              ...
              boolean _equals = level.equals(levelId);
              if (_equals) {
                String _identifier = s.getIdentifier();
                boolean _contains = levelVars.contains(_identifier);
                boolean _not = (!_contains);
                if (_not) {
                  String _identifier_1 = s.getIdentifier();
                  levelVars.add(_identifier_1);
                }
              }
            }
          }
  ...
  public String getAttribute(final DistributionArguments a, final String attrName) {
    EList<DistributionArgument> _arguments = a.getArguments();
    for (final DistributionArgument arg : _arguments) {
      boolean _and = false;
      String _identifier = arg.getIdentifier();
      ...
      if (_and) {
        return this.valueToStr(arg);
      }
    }
    return "";
  }
  
  public DistributionArgument findAttribute(final DistributionArguments a, final String attrName) {
    EList<DistributionArgument> _arguments = a.getArguments();
    for (final DistributionArgument arg : _arguments) {
      boolean _and = false;
      String _identifier = arg.getIdentifier();
  ...
  public String valueToStr(final DistributionArgument arg) {
    Distribution _distribution = arg.getDistribution();
    boolean _notEquals = (!Objects.equal(_distribution, null));
    if (_notEquals) {
      Distribution _distribution_1 = arg.getDistribution();
      return _distribution_1.getIdentifier();
    }
    Primary _value = arg.getValue();
    boolean _notEquals_1 = (!Objects.equal(_value, null));
    if (_notEquals_1) {
      Primary _value_1 = arg.getValue();
      return this.toStr(_value_1);
    }
    RandomList _component = arg.getComponent();
    boolean _notEquals_2 = (!Objects.equal(_component, null));
    if (_notEquals_2) {
      RandomList _component_1 = arg.getComponent();
      return this.toStr(_component_1);
    }
    return "";
  }
  ...
  public String toStr(final EnumType type) {
    String _xblockexpression = null;
    {
      ...
      boolean _notEquals_3 = (!Objects.equal(_use, null));
      if (_notEquals_3) {
        UseType _use_1 = type.getUse();
        return this.toStr(_use_1);
      }
      Likelyhood _likelyhood = type.getLikelyhood();
      boolean _notEquals_4 = (!Objects.equal(_likelyhood, null));
      if (_notEquals_4) {
  ...
  public String toStr(final RandomList l) {
    DistributionArguments _arguments = l.getArguments();
    boolean _notEquals = (!Objects.equal(_arguments, null));
    if (_notEquals) {
      String _plus = ("~" + "(");
      DistributionArguments _arguments_1 = l.getArguments();
      String _str = this.toStr(_arguments_1);
      String _plus_1 = (_plus + _str);
      return (_plus_1 + ")");
    }
  ...
  public String toStr(final DistributionArguments arg) {
    String res = "";
    EList<DistributionArgument> _arguments = arg.getArguments();
    Iterator<DistributionArgument> iterator = _arguments.iterator();
    boolean _hasNext = iterator.hasNext();
    if (_hasNext) {
      DistributionArgument a = iterator.next();
      String _identifier = a.getIdentifier();
      boolean _notEquals = (!Objects.equal(_identifier, null));
      if (_notEquals) {
        String _identifier_1 = a.getIdentifier();
      ...
      String _valueToStr = this.valueToStr(a);
      String _plus_2 = (res + _valueToStr);
      res = _plus_2;
    }
    boolean _hasNext_1 = iterator.hasNext();
    boolean _while = _hasNext_1;
    while (_while) {
      {
        String _plus_3 = (res + ", ");
        res = _plus_3;
        DistributionArgument a_1 = iterator.next();
        String _identifier_2 = a_1.getIdentifier();
        ...
        String _valueToStr_1 = this.valueToStr(a_1);
        String _plus_6 = (res + _valueToStr_1);
        res = _plus_6;
      }
      boolean _hasNext_2 = iterator.hasNext();
      _while = _hasNext_2;
  ...
  public String print(final Block b) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<BlockStatement> _statements = b.getStatements();
      for(final BlockStatement st : _statements) {
        String _print = this.print(st);
  ...
  public String print(final BlockStatement st) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if (_notEquals) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          if (_notEquals_1) {
            ...
            String _print_1 = this.print(_ifStatement_1);
            _builder.append(_print_1, "	");
            _builder.newLineIfNotEmpty();
          }
        }
        {
          ...
          if (_notEquals_2) {
            ...
            String _print_2 = this.print(_ifBlock_1);
            _builder.append(_print_2, "	");
            _builder.newLineIfNotEmpty();
          }
        }
          ...
          if (_or) {
            ...
            _builder.newLine();
            {
              ...
              if (_notEquals_5) {
                ...
                String _print_3 = this.print(_elseStatement_2);
                _builder.append(_print_3, "	");
                _builder.newLineIfNotEmpty();
              }
            }
            {
              ...
              if (_notEquals_6) {
                ...
                String _print_4 = this.print(_elseBlock_2);
