...
; Target	: NMTRAN 7.2.0
; Model 	: Hansson_2013_oncology_Sunitib_VEGF_combError3
; Dated 	: Wed Feb 11 14:01:34 GMT 2015

$PROBLEM "Hansson_2013_oncology_Sunitib_VEGF_combError3 - generated by MDL2PharmML v.6.0"
...
POP_HILL = THETA(4)
POP_TVSLP = THETA(5)
POP_RES_VEGF_PROP = THETA(6)
POP_IMAX = THETA(7)
POP_RES_VEGF_ADD = THETA(8)
...
$ERROR
IPRED = LOG(A(1))
W = SQRT(POP_RES_VEGF_PROP**2 + (POP_RES_VEGF_ADD/A(1))**2)
Y = IPRED+W*EPS(1)
IRES = DV - IPRED
IWRES = IRES/W
