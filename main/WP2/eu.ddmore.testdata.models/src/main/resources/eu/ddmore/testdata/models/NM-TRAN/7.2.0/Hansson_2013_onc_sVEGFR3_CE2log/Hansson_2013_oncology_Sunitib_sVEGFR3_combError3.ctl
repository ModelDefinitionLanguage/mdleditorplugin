...
; Target	: NMTRAN 7.2.0
; Model 	: Hansson_2013_oncology_Sunitib_sVEGFR3_combError3
; Dated 	: Wed Feb 11 14:01:29 GMT 2015

$PROBLEM "Hansson_2013_oncology_Sunitib_sVEGFR3_combError3 - generated by MDL2PharmML v.6.0"
...
POP_BM03 = THETA(2)
POP_MRT3 = THETA(3)
POP_RES_sVEGFR3_PROP = THETA(4)
POP_IMAX = THETA(5)
POP_RES_sVEGFR3_ADD = THETA(6)
...
$ERROR
IPRED = LOG(A(1))
W = SQRT(POP_RES_SVEGFR3_PROP**2 + (POP_RES_SVEGFR3_ADD/A(1))**2)
Y = IPRED+W*EPS(1)
IRES = DV - IPRED
IWRES = IRES/W
