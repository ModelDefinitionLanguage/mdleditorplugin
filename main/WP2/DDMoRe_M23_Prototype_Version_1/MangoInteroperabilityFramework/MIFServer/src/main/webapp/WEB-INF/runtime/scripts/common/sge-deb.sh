SGE_ROOT=/usr/global/sge; export SGE_ROOT

ARCH=`$SGE_ROOT/util/arch-deb`
DEFAULTMANPATH=`$SGE_ROOT/util/arch-deb -m`
MANTYPE=`$SGE_ROOT/util/arch-deb -mt`
...
#PATH=/usr/global/sge-mockgrid:$PATH; export PATH
