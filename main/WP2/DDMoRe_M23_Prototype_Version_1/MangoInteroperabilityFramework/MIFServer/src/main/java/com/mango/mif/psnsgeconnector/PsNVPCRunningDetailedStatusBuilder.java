/* File			:  PsNVPCRunningDetailedStatusBuilder.java
 * Project		:  MIFServer
 ...
 * 
 * The class is responsible for generating summary messages during PsN VPC execution
 * 
 */
public class PsNVPCRunningDetailedStatusBuilder extends 
DetailedStatusBuilderWithCommandBuilder {

    private static final Logger LOG = Logger.getLogger(PsNVPCRunningDetailedStatusBuilder.class);
