/* File			:  PsNBootstrapCompletedDetailedStatusBuilder.java
 * Project		:  MIFServer
 ...
 * 
 * Generates a summary message for PsN Bootstrap execution that is in completed state
 * 
 */
public class PsNBootstrapCompletedDetailedStatusBuilder extends
        DetailedStatusBuilderWithCommandBuilder {

    private static final Logger LOG = Logger.getLogger(PsNBootstrapCompletedDetailedStatusBuilder.class);
