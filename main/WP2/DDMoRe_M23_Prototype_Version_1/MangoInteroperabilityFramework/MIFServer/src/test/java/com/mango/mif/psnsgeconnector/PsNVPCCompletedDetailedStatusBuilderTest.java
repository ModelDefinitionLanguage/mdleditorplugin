/* File			:  PsNVPCCompletedDetailedStatusBuilderTest.java
 * Project		:  MIFServer
 ...
 * 
 * Tests PsNVPCCompletedDetailedStatusBuilder
 * 
 */
public class PsNVPCCompletedDetailedStatusBuilderTest extends SummaryMessageBuilderTest {
    /**
     * Test data
     */
    private String testData = "/testData/outputs/PsN_VPC/vpc-completed";
    /**
     * Control file
     */
     ...
     */
    private String commandTemplate = "psnvpcsgeconnector/completed-summary-message.ftl";
    ...
    private Job prepareJob() {
        ...
        File workingDir = FileUtils.toFile(PsNVPCCompletedDetailedStatusBuilderTest.class.getResource(this.testData));
    ...
    public void shouldGenerateDetailedStatusForCompletedVPC() throws ExecutionException, JAXBException {
        ...
        prepareJob();
        job.getExecutionRequest().setExecutionParameters("-directory=vpc");
        String testData = "/testData/outputs/PsN_VPC/vpc-completed";
        File workingDir = FileUtils.toFile(PsNVPCCompletedDetailedStatusBuilderTest.class.getResource(testData));
        job.setGridJobDirectory(workingDir.getAbsolutePath());
        when(sharedLocationManager.getRequestInputDirectory((String) any())).thenReturn(workingDir);
        when(sharedLocationManager.getRequestOutputDirectory((String) any())).thenReturn(workingDir);
        //when
        PsNVPCCompletedDetailedStatusBuilder messageBuilder = new PsNVPCCompletedDetailedStatusBuilder();
        ...
        assertThat(summary.getSummary(), equalTo("FOCE INTER: 6752.459"));
    }
