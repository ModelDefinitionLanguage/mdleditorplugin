...
$INPUT      ID PERD PROT TIME AMT DV EVID MDV ADDL II FED AGE=DROP
            SEXF=DROP WT=DROP HT=DROP RACE=DROP BMI BSA CRCL=DROP DOSE
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/m1/CLBMI2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0348993  ; [P] INTERIND VAR IN CL
 5.03674E-06  ; [P] INTERIND VAR IN V2
 0.0554562  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; CLBMI-DEFINITION START
CLBMI = ( 1 + THETA(9)*(BMI - 26.73))
...
$THETA  6.02534 ; 1 [CL]
 ...
 5.85437 ; 5[Q]
 9.33958 ; 6 [V3]
$THETA  (-2.941,0.478127,4.166) ; CLBSA1
$THETA  (-0.166,-0.0457614,0.185) ; V2BMI1
$THETA  (-0.166,-0.000166,0.185) ; CLBMI1
$SIGMA  0.121153  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1//m1/CLBMI2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1//m1/CLBMI2.mod.patab1
