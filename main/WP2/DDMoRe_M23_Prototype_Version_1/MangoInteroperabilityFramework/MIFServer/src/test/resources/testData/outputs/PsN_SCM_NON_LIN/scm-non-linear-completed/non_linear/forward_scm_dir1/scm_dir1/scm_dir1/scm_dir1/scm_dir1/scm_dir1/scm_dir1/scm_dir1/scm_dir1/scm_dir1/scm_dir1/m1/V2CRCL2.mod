...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2CRCL2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0236976  ; [P] INTERIND VAR IN CL
 1.7703E-08  ; [P] INTERIND VAR IN V2
 0.0305055  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; V2CRCL-DEFINITION START
V2CRCL = ( 1 + THETA(20)*(CRCL - 60.23))
...
;;; V2-RELATION START
V2COV=V2AGE*V2BMI*V2HT*V2RACE*V2SEXF*V2WT*V2CRCL
;;; V2-RELATION END
...
$THETA  6.18584 ; 1 [CL]
 ...
 5.85731 ; 5[Q]
 9.32921 ; 6 [V3]
$THETA  (-0.055,0.00430447,0.029) ; CLAGE1
$THETA  (-0.166,0.0272333,0.185) ; CLBMI1
$THETA  (-0.012,-0.00232554,0.028) ; CLCRCL1
$THETA  (-0.046,0.0169812,0.078) ; CLHT1
$THETA  (-1,-0.249875,5) ; CLRACE1
 (-1,-0.191175,5) ; CLRACE2
$THETA  (-0.055,0.00867576,0.029) ; V2AGE1
$THETA  (-0.166,0.0111201,0.185) ; V2BMI1
$THETA  (-0.046,0.0118958,0.078) ; V2HT1
$THETA  (-1,0.673406,5) ; V2RACE1
 (-1,-0.447649,5) ; V2RACE2
$THETA  (-1,2.20331,5) ; V2SEXF1
$THETA  (-0.041,-0.0272876,0.074) ; V2WT1
$THETA  (-0.012,-1.2E-05,0.028) ; V2CRCL1
$SIGMA  0.120516  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.patab1
