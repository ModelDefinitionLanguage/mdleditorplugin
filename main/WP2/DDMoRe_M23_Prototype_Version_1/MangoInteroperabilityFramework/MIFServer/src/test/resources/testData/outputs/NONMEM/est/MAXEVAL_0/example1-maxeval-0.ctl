...
$EST METHOD=ITS INTERACTION FILE=example1.ext MAXEVAL=0 NITER=500 PRINT=5 NOABORT SIGL=4 CTYPE=3 CITER=10   
...
$EST METHOD=COND INTERACTION MAXEVAL=9999 NSIG=3 SIGL=10 PRINT=5 NOABORT MAXEVAL=0 NOPRIOR=1
     FILE=example1.ext
...
$TABLE ID CL V1 Q V2 FIRSTONLY NOAPPEND NOPRINT FILE=exampl1.PAR
