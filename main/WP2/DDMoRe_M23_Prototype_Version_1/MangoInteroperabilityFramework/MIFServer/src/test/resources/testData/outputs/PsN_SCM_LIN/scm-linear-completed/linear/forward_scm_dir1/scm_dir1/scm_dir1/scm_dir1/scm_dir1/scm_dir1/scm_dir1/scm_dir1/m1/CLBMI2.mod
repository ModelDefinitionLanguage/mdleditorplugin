...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/CLBMI2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0309962  ; [P] INTERIND VAR IN CL
 1.33266E-08  ; [P] INTERIND VAR IN V2
 0.0341263  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; CLBMI-DEFINITION START
CLBMI = ( 1 + THETA(15)*(BMI - 26.73))
...
$THETA  5.93678 ; 1 [CL]
 ...
 5.86027 ; 5[Q]
 9.33298 ; 6 [V3]
$THETA  (-0.055,0.00517304,0.029) ; CLAGE1
$THETA  (-2.941,0.721495,4.166) ; CLBSA1
$THETA  (-0.012,-0.0032695,0.028) ; CLCRCL1
$THETA  (-1,0.46919,5) ; CLSEXF1
$THETA  (-0.055,0.0055054,0.029) ; V2AGE1
$THETA  (-0.166,0.0424408,0.185) ; V2BMI1
$THETA  (-1,1.57839,5) ; V2SEXF1
$THETA  (-0.041,-0.0285731,0.074) ; V2WT1
$THETA  (-0.166,-0.000166,0.185) ; CLBMI1
$SIGMA  0.121065  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/CLBMI2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/CLBMI2.mod.patab1
