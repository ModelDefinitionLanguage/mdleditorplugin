...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1/m1/CLBMI1_data_1_copy.dta
            IGNORE=@
...
;;; CL-RELATION START
CLCOV=CLAGE*CLBSA*CLCRCL*CLHT*CLSEXF*CLWT
;;; CL-RELATION END
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1//m1/CLBMI1.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1//m1/CLBMI1.mod.patab1
