      ...
      REAL(KIND=DPSIZE), POINTER ::STRT,TVCL,MU_1,CL,TVV2,MU_2,V2,TVKA
      REAL(KIND=DPSIZE), POINTER ::MU_3,KA,TVF1,F1,TVQ,MU_4,Q,TVV3
      REAL(KIND=DPSIZE), POINTER ::MU_5,V3,S2,IPRED,IRES,DEL,W,IWRES,Y
      REAL(KIND=DPSIZE), POINTER ::A00073,A00075,A00078,A00080,A00083
      REAL(KIND=DPSIZE), POINTER ::A00085,A00088,A00090,A00093,A00095
      REAL(KIND=DPSIZE), POINTER ::A00096,A00097,D00111,D00112,D00113
      REAL(KIND=DPSIZE), POINTER ::D00114,D00115,D00165,D00164,D00163
      REAL(KIND=DPSIZE), POINTER ::D00162,D00161,C00072,D00300,D00299
      REAL(KIND=DPSIZE), POINTER ::D00298,D00297,D00296
      CONTAINS
      SUBROUTINE ASSOCNMPRD4
      COM=>VRBL
      STRT=>COM(00001);TVCL=>COM(00002);MU_1=>COM(00003)
      CL=>COM(00004);TVV2=>COM(00005);MU_2=>COM(00006);V2=>COM(00007)
      TVKA=>COM(00008);MU_3=>COM(00009);KA=>COM(00010)
      TVF1=>COM(00011);F1=>COM(00012);TVQ=>COM(00013);MU_4=>COM(00014)
      Q=>COM(00015);TVV3=>COM(00016);MU_5=>COM(00017);V3=>COM(00018)
      S2=>COM(00019);IPRED=>COM(00020);IRES=>COM(00021)
      DEL=>COM(00022);W=>COM(00023);IWRES=>COM(00024);Y=>COM(00025)
      A00073=>COM(00026);A00075=>COM(00027);A00078=>COM(00028)
      A00080=>COM(00029);A00083=>COM(00030);A00085=>COM(00031)
      A00088=>COM(00032);A00090=>COM(00033);A00093=>COM(00034)
      A00095=>COM(00035);A00096=>COM(00036);A00097=>COM(00037)
      D00111=>COM(00038);D00112=>COM(00039);D00113=>COM(00040)
      D00114=>COM(00041);D00115=>COM(00042);D00165=>COM(00043)
      D00164=>COM(00044);D00163=>COM(00045);D00162=>COM(00046)
      D00161=>COM(00047);C00072=>COM(00048);D00300=>COM(00049)
      D00299=>COM(00050);D00298=>COM(00051);D00297=>COM(00052)
      D00296=>COM(00053)
...
!                      A00093 = DERIVATIVE OF V3 W.R.T. ETA(05)
      ...
      B00011=624.709D0/1.D6 
!                      A00096 = DERIVATIVE OF S2 W.R.T. ETA(02)
      A00096=B00011*A00078 
      GG(01,1,1)=CL    
      GG(01,02,1)=A00073
      GG(02,1,1)=V2    
      GG(02,03,1)=A00078
