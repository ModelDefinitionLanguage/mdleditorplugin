...
$INPUT      ID PERD PROT TIME AMT DV EVID MDV ADDL II FED AGE SEXF WT
            HT=DROP RACE BMI BSA=DROP CRCL DOSE
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2CRCL2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0261444  ; [P] INTERIND VAR IN CL
 1.81289E-08  ; [P] INTERIND VAR IN V2
 0.0344107  ; [P] INTERIND VAR IN KA
...
IF(RACE.EQ.3) V2RACE = ( 1 + THETA(12))
IF(RACE.EQ.1) V2RACE = ( 1 + THETA(13))
;;; V2RACE-DEFINITION END


;;; V2BMI-DEFINITION START
V2BMI = ( 1 + THETA(11)*(BMI - 26.73))
...
IF(RACE.EQ.3) CLRACE = ( 1 + THETA(9))
IF(RACE.EQ.1) CLRACE = ( 1 + THETA(10))
...
$THETA  6.17927 ; 1 [CL]
 ...
 5.85554 ; 5[Q]
 9.3293 ; 6 [V3]
$THETA  (-0.055,0.00198175,0.029) ; CLAGE1
$THETA  (-0.166,0.0207545,0.185) ; CLBMI1
$THETA  (-1,-0.279422,5) ; CLRACE1
 (-1,-0.148244,5) ; CLRACE2
$THETA  (-0.166,0.00734748,0.185) ; V2BMI1
$THETA  (-1,0.681003,5) ; V2RACE1
 (-1,-0.418485,5) ; V2RACE2
$THETA  (-1,1.84771,5) ; V2SEXF1
$THETA  (-0.041,-0.0238869,0.074) ; V2WT1
$THETA  (-0.012,-1.2E-05,0.028) ; V2CRCL1
$SIGMA  0.120428  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-non-linear/scm-non-linear/non_linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.patab1
