...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2HT2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0291506  ; [P] INTERIND VAR IN CL
 1.30971E-08  ; [P] INTERIND VAR IN V2
 0.0233341  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; V2HT-DEFINITION START
V2HT = ( 1 + THETA(20)*(HT - 165.10))
;;; V2HT-DEFINITION END
...
;;; CL-RELATION START
CLCOV=CLAGE*CLBMI*CLBSA*CLCRCL*CLHT*CLSEXF*CLWT
;;; CL-RELATION END
...
$THETA  6.02454 ; 1 [CL]
 ...
 5.85701 ; 5[Q]
 9.32459 ; 6 [V3]
$THETA  (-0.055,0.00428214,0.029) ; CLAGE1
$THETA  (-0.166,-0.0448654,0.185) ; CLBMI1
$THETA  (-2.941,0.972281,4.166) ; CLBSA1
$THETA  (-0.012,-0.00223379,0.028) ; CLCRCL1
$THETA  (-0.046,-0.0179631,0.078) ; CLHT1
$THETA  (-1,0.422865,5) ; CLSEXF1
$THETA  (-0.041,0.0122401,0.074) ; CLWT1
$THETA  (-0.055,0.0103069,0.029) ; V2AGE1
$THETA  (-0.166,0.0317518,0.185) ; V2BMI1
$THETA  (-2.941,-1.63595,4.166) ; V2BSA1
$THETA  (-0.012,0.0151185,0.028) ; V2CRCL1
$THETA  (-1,0.770813,5) ; V2SEXF1
$THETA  (-0.041,-0.0239948,0.074) ; V2WT1
$THETA  (-0.046,-4.6E-05,0.078) ; V2HT1
$SIGMA  0.121615  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.patab1
