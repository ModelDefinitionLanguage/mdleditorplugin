...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1/m1/V2AGE1_data_1_copy.dta
            IGNORE=@
...
;;; V2-RELATION START
V2COV=V2BMI*V2BSA*V2CRCL*V2HT*V2SEXF*V2WT
;;; V2-RELATION END
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1//m1/V2AGE1.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/backward_scm_dir1//m1/V2AGE1.mod.patab1
