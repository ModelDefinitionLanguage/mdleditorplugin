...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2HT2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0307898  ; [P] INTERIND VAR IN CL
 1.34444E-08  ; [P] INTERIND VAR IN V2
 0.0358721  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; V2HT-DEFINITION START
V2HT = ( 1 + THETA(14)*(HT - 165.10))
;;; V2HT-DEFINITION END


;;; V2WT-DEFINITION START
V2WT = ( 1 + THETA(13)*(WT - 75.39))
;;; V2WT-DEFINITION END


;;; V2SEXF-DEFINITION START
IF(SEXF.EQ.1) V2SEXF = 1  ; Most common
IF(SEXF.EQ.0) V2SEXF = ( 1 + THETA(12))
...
$THETA  5.93491 ; 1 [CL]
 ...
 5.85916 ; 5[Q]
 9.33379 ; 6 [V3]
$THETA  (-0.055,0.00522244,0.029) ; CLAGE1
$THETA  (-2.941,0.720594,4.166) ; CLBSA1
$THETA  (-0.012,-0.00326207,0.028) ; CLCRCL1
$THETA  (-1,0.473169,5) ; CLSEXF1
$THETA  (-0.166,0.0484823,0.185) ; V2BMI1
$THETA  (-1,1.19216,5) ; V2SEXF1
$THETA  (-0.041,-0.0281465,0.074) ; V2WT1
$THETA  (-0.046,-4.6E-05,0.078) ; V2HT1
$SIGMA  0.121005  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.patab1
