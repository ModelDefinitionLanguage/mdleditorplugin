...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2CRCL2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0346794  ; [P] INTERIND VAR IN CL
 1.34983E-08  ; [P] INTERIND VAR IN V2
 0.0357048  ; [P] INTERIND VAR IN KA
 0  FIX  ; [P] INTERIND VAR IN Q
 0  FIX  ; [P] INTERIND VAR IN V3
$PK

;;; V2CRCL-DEFINITION START
V2CRCL = ( 1 + THETA(12)*(CRCL - 60.23))
;;; V2CRCL-DEFINITION END


;;; V2WT-DEFINITION START
V2WT = ( 1 + THETA(11)*(WT - 75.39))
;;; V2WT-DEFINITION END


;;; V2SEXF-DEFINITION START
IF(SEXF.EQ.1) V2SEXF = 1  ; Most common
IF(SEXF.EQ.0) V2SEXF = ( 1 + THETA(10))
...
$THETA  6.04467 ; 1 [CL]
 ...
 5.85885 ; 5[Q]
 9.33413 ; 6 [V3]
$THETA  (-2.941,0.726204,4.166) ; CLBSA1
$THETA  (-0.012,-0.00111603,0.028) ; CLCRCL1
$THETA  (-0.166,0.0486427,0.185) ; V2BMI1
$THETA  (-1,1.18683,5) ; V2SEXF1
$THETA  (-0.041,-0.0281229,0.074) ; V2WT1
$THETA  (-0.012,-1.2E-05,0.028) ; V2CRCL1
$SIGMA  0.121009  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2CRCL2.mod.patab1
