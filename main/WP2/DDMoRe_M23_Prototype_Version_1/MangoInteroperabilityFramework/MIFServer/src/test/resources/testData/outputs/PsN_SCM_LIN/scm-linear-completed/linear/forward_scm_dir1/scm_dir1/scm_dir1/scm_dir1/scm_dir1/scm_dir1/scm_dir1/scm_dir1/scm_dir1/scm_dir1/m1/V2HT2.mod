...
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2HT2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0304965  ; [P] INTERIND VAR IN CL
 1.33703E-08  ; [P] INTERIND VAR IN V2
 0.0233889  ; [P] INTERIND VAR IN KA
...
;;; CL-RELATION START
CLCOV=CLAGE*CLBSA*CLCRCL*CLSEXF
;;; CL-RELATION END
...
$THETA  5.93289 ; 1 [CL]
 ...
 5.85748 ; 5[Q]
 9.32509 ; 6 [V3]
$THETA  (-0.055,0.00511467,0.029) ; CLAGE1
$THETA  (-2.941,0.700905,4.166) ; CLBSA1
$THETA  (-0.012,-0.00316259,0.028) ; CLCRCL1
$THETA  (-1,0.462107,5) ; CLSEXF1
$THETA  (-0.055,0.0102268,0.029) ; V2AGE1
$THETA  (-0.166,0.0321295,0.185) ; V2BMI1
$THETA  (-2.941,-1.63076,4.166) ; V2BSA1
$THETA  (-0.012,0.014948,0.028) ; V2CRCL1
$THETA  (-1,0.780004,5) ; V2SEXF1
$THETA  (-0.041,-0.0240045,0.074) ; V2WT1
$THETA  (-0.046,-4.6E-05,0.078) ; V2HT1
$SIGMA  0.121603  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.patab1
