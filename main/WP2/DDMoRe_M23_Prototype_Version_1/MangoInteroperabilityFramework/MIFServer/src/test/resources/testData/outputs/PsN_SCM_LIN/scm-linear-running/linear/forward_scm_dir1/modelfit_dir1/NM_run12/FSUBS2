      ...
      REAL(KIND=DPSIZE), POINTER ::V2SEXF,V2BMI,V2COV,STRT,TVCL,MU_1
      REAL(KIND=DPSIZE), POINTER ::CL,TVV2,MU_2,V2,TVKA,MU_3,KA,TVF1
      REAL(KIND=DPSIZE), POINTER ::F1,TVQ,MU_4,Q,TVV3,MU_5,V3,S2,IPRED
      ...
      COM=>VRBL
      V2SEXF=>COM(00001);V2BMI=>COM(00002);V2COV=>COM(00003)
      ...
      ENDIF 
      IF(SEXF == 0.D0)THEN 
      B00006=1.D0+THETA(08) 
      V2SEXF=B00006 
      ENDIF 
      B00008=BMI-26.73D0 
      B00009=1.D0+THETA(07)*B00008 
      V2BMI=B00009 
      V2COV=V2BMI*V2SEXF 
...
!                      A00093 = DERIVATIVE OF V3 W.R.T. ETA(05)
      ...
      B00021=624.709D0/1.D6 
!                      A00096 = DERIVATIVE OF S2 W.R.T. ETA(02)
      A00096=B00021*A00078 
      GG(01,1,1)=CL    
      GG(01,02,1)=A00073
      GG(02,1,1)=V2    
      GG(02,03,1)=A00078
