...
;$TABLE      ID CL V2 KA F1 Q V3 CMAX AUC ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
;            FILE=patab1
...
$TABLE ID PROT SEXF RACE FED NOPRINT ONEHEADER FILE=catab11
