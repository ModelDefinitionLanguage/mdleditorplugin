...
$EST METHOD=ITS INTERACTION NITER=100 PRINT=1 NOABORT SIGL=8 CTYPE=3
...
ONEHEADER NOPRINT FILE=warf_cov_est.fit

$TABLE ID  SEX AGE WT CL V ETA(1) ETA(2)
ONEHEADER NOAPPEND NOPRINT FILE=warf_cov_est.fit
