...
$OMEGA  DIAGONAL(5)
 0.0292592  ; [P] INTERIND VAR IN CL
 9.78867E-09  ; [P] INTERIND VAR IN V2
 0.0222476  ; [P] INTERIND VAR IN KA
...
$THETA  6.02955 ; 1 [CL]
 ...
 5.85779 ; 5[Q]
 9.3225 ; 6 [V3]
$THETA  (-0.055,0.00424143,0.029) ; CLAGE1
$THETA  (-0.166,-0.0458664,0.185) ; CLBMI1
$THETA  (-2.941,0.9886,4.166) ; CLBSA1
$THETA  (-0.012,-0.0022133,0.028) ; CLCRCL1
$THETA  (-0.046,-0.018228,0.078) ; CLHT1
$THETA  (-1,0.414324,5) ; CLSEXF1
$THETA  (-0.041,0.0123913,0.074) ; CLWT1
$THETA  (-0.055,0.010956,0.029) ; V2AGE1
$THETA  (-0.166,0.040361,0.185) ; V2BMI1
$THETA  (-2.941,-1.78054,4.166) ; V2BSA1
$THETA  (-0.012,0.0144517,0.028) ; V2CRCL1
$THETA  (-1,0.778205,5) ; V2SEXF1
$THETA  (-0.041,-0.0243376,0.074) ; V2WT1
$THETA  (-0.046,0.00671375,0.078) ; V2HT1
$SIGMA  0.121693  ; [P] Variance for proportional error
