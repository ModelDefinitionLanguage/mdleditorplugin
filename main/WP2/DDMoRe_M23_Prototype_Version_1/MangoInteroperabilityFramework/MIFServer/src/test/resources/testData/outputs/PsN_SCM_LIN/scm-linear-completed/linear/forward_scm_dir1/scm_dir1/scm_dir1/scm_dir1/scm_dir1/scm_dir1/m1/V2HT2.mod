...
$INPUT      ID PERD PROT TIME AMT DV EVID MDV ADDL II FED AGE=DROP
            SEXF WT HT RACE=DROP BMI BSA CRCL DOSE
$DATA      
            /net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/m1/V2HT2_data_1_copy.dta
            IGNORE=@
$SUBROUTINE ADVAN4 TRANS4
$OMEGA  DIAGONAL(5)
 0.0320238  ; [P] INTERIND VAR IN CL
 1.34875E-08  ; [P] INTERIND VAR IN V2
 0.0357556  ; [P] INTERIND VAR IN KA
...
IF(SEXF.EQ.0) CLSEXF = ( 1 + THETA(9))
;;; CLSEXF-DEFINITION END


;;; CLCRCL-DEFINITION START
CLCRCL = ( 1 + THETA(8)*(CRCL - 60.23))
...
$THETA  5.99491 ; 1 [CL]
 ...
 5.85895 ; 5[Q]
 9.33375 ; 6 [V3]
$THETA  (-2.941,0.783303,4.166) ; CLBSA1
$THETA  (-0.012,-0.00346431,0.028) ; CLCRCL1
$THETA  (-1,0.24889,5) ; CLSEXF1
$THETA  (-0.166,0.0483843,0.185) ; V2BMI1
$THETA  (-1,1.19405,5) ; V2SEXF1
$THETA  (-0.041,-0.0281629,0.074) ; V2WT1
$THETA  (-0.046,-4.6E-05,0.078) ; V2HT1
$SIGMA  0.121027  ; [P] Variance for proportional error
...
$TABLE      ID TIME IPRED EVID MDV CWRES IWRES STRT NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.sdtab1
...
$TABLE      ID CL V2 KA F1 Q V3 ETA1 ETA2 ETA3 ETA4 NOPRINT ONEHEADER
            FILE=/net/navtst-nonmem/usr/global/mrogalski/other/scm-linear/scm-linear/linear/forward_scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1/scm_dir1//m1/V2HT2.mod.patab1
