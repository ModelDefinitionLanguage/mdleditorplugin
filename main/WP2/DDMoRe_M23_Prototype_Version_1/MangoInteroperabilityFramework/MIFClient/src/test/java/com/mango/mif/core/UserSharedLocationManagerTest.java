...
public class UserSharedLocationManagerTest {
    ...
    @Test
    public void shouldReturnInputsAndOutputsDirectories() {
        assertEquals("outputs", userSharedLocationManager.getRequestOutputDirectory(requestUUID).getName());
        assertEquals("inputs", userSharedLocationManager.getRequestInputDirectory(requestUUID).getName());
    }
    

    @Test
    public void shouldReturnRequestDirForInputAndOutput() {
        userSharedLocationManager.setRunInRequestDirectory(true);
        assertEquals(requestUUID, userSharedLocationManager.getRequestOutputDirectory(requestUUID).getName());
        assertEquals(requestUUID, userSharedLocationManager.getRequestInputDirectory(requestUUID).getName());
    }
}
