 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_SymbolTypeTypeImpl#getScalar <em>Scalar</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_SymbolTypeTypeImpl#getDerivative <em>Derivative</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_SymbolTypeTypeImpl#getDistrib <em>Distrib</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_SymbolTypeTypeImpl#getDataSet <em>Data Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_SymbolTypeTypeImpl extends MinimalEObjectImpl.Container implements ct_SymbolTypeType
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_SymbolTypeType();
  }
  ...
  public void setScalar(String newScalar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE_TYPE__SCALAR, oldScalar, scalar));
  }
  ...
  public void setDerivative(String newDerivative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DERIVATIVE, oldDerivative, derivative));
  }
  ...
  public void setDistrib(String newDistrib)
  {
    ...
    distrib = newDistrib;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DISTRIB, oldDistrib, distrib));
  }
  ...
  public void setDataSet(String newDataSet)
  {
    ...
    dataSet = newDataSet;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DATA_SET, oldDataSet, dataSet));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_SYMBOL_TYPE_TYPE__SCALAR:
        return getScalar();
      case PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DERIVATIVE:
        return getDerivative();
      case PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DISTRIB:
        return getDistrib();
      case PharmMLPackage.CT_SYMBOL_TYPE_TYPE__DATA_SET:
        return getDataSet();
    }
