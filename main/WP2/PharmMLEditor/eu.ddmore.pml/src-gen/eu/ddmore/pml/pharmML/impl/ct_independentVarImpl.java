 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_independentVarImpl#getIndependentVar <em>Independent Var</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_independentVarImpl extends MinimalEObjectImpl.Container implements ct_independentVar
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_independentVar();
  }
  ...
  public void setIndependentVar(String newIndependentVar)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_INDEPENDENT_VAR__INDEPENDENT_VAR, oldIndependentVar, independentVar));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_INDEPENDENT_VAR__INDEPENDENT_VAR:
