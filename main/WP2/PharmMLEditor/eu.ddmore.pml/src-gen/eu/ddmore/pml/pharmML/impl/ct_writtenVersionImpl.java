 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_writtenVersionImpl#getWrittenVersion <em>Written Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_writtenVersionImpl extends MinimalEObjectImpl.Container implements ct_writtenVersion
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_writtenVersion();
  }
  ...
  public void setWrittenVersion(String newWrittenVersion)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_WRITTEN_VERSION__WRITTEN_VERSION, oldWrittenVersion, writtenVersion));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_WRITTEN_VERSION__WRITTEN_VERSION:
