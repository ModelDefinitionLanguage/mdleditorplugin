...
import eu.ddmore.pml.pharmML.PharmMLFactory;
 ...
 * @generated
 */
public class PharmMLPackageImpl extends EPackageImpl implements PharmMLPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected String packageFilename = "pharmML.ecore";
   ...
   * @generated
   */
  private EClass mml_PharmMLEClass = null;
   ...
   * @generated
   */
  private EClass mml_PharmaMLContentEClass = null;
   ...
   * @generated
   */
  private EClass mdef_ContinuousObsModelTypeEClass = null;
   ...
   * @generated
   */
  private EClass mdef_ErrorModelEClass = null;
   ...
   * @generated
   */
  private EClass mdef_Param1VarTypeEClass = null;
   ...
   * @generated
   */
  private EClass mdef_Param2VarTypeEClass = null;
   ...
   * @generated
   */
  private EClass mdef_ContinuousCovariateTypeEClass = null;
   ...
   * @generated
   */
  private EClass mdef_ParameterRandomEffectTypeEClass = null;
   ...
   * @generated
   */
  private EClass msteps_ModelingStepsContentEClass = null;
   ...
   * @generated
   */
  private EClass msteps_ColumnMappingTypeEClass = null;
   ...
   * @generated
   */
  private EClass msteps_ColumnMappingTypeContentEClass = null;
   ...
   * @generated
   */
  private EClass design_GroupTypeContentEClass = null;
   ...
   * @generated
   */
  private EClass design_TreatmentEpochRefTypeEClass = null;
   ...
   * @generated
   */
  private EClass design_DosingTimesTypeContentEClass = null;
   ...
   * @generated
   */
  private EClass design_DosingVariableTypeContentEClass = null;
   ...
   * @generated
   */
  private EClass uncert_DistributionTypeContentEClass = null;
   ...
   * @generated
   */
  private EClass math_OtherwiseEClass = null;
   ...
   * @generated
   */
  private EClass ct_NullCellTypeEClass = null;
   ...
   * @generated
   */
  private EClass xS_xmlnsEClass = null;
   ...
   * @generated
   */
  private EClass mml_FuncParameterDefinitionTypEClass = null;
   ...
   * @see eu.ddmore.pml.pharmML.PharmMLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private PharmMLPackageImpl()
  {
    super(eNS_URI, PharmMLFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link PharmMLPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static PharmMLPackage init()
  {
    if (isInited) return (PharmMLPackage)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI);

    // Obtain or create and register package
    PharmMLPackageImpl thePharmMLPackage = (PharmMLPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PharmMLPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PharmMLPackageImpl());

    isInited = true;

    // Load packages
    thePharmMLPackage.loadPackage();

    // Fix loaded packages
    thePharmMLPackage.fixPackageContents();

    // Mark meta-data to indicate it can't be changed
    thePharmMLPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(PharmMLPackage.eNS_URI, thePharmMLPackage);
    return thePharmMLPackage;
  }
   ...
   * @generated
   */
  public EClass getMml_PharmML()
  {
    if (mml_PharmMLEClass == null)
    {
      mml_PharmMLEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(0);
    }
    return mml_PharmMLEClass;
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_Xmlns()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_Name()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_IndependentVar()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_WrittenVersion()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_SymbolDefinition()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_Expr()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(5);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_Design()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(6);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmML_ModelingSteps()
  {
        return (EReference)getMml_PharmML().getEStructuralFeatures().get(7);
  }
   ...
   * @generated
   */
  public EClass getMml_PharmaMLContent()
  {
    if (mml_PharmaMLContentEClass == null)
    {
      mml_PharmaMLContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(1);
    }
    return mml_PharmaMLContentEClass;
  }
   ...
   * @generated
   */
  public EReference getMml_PharmaMLContent_StructuralModel()
  {
        return (EReference)getMml_PharmaMLContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getMml_PharmaMLContent_ModelDefinition()
  {
        return (EReference)getMml_PharmaMLContent().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getMml_SymbolDefinitionType()
  {
    ...
    {
      mml_SymbolDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(2);
    }
  ...
  public EClass getMml_FunctionDefinitionType()
  {
    ...
    {
      mml_FunctionDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(3);
    }
  ...
  public EClass getMml_FuncParameterDefinitionType()
  {
    ...
    {
      mml_FuncParameterDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(4);
    }
  ...
  public EClass getmdef_ModelDefinitionType()
  {
    ...
    {
      mdef_ModelDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(5);
    }
  ...
  public EClass getmdef_ParameterTypeName()
  {
    ...
    {
      mdef_ParameterTypeNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(6);
    }
  ...
  public EClass getmdef_StructuralModelType()
  {
    ...
    {
      mdef_StructuralModelTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(7);
    }
  ...
  public EClass getmdef_ObservationModelType()
  {
    ...
    {
      mdef_ObservationModelTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(8);
    }
   ...
   * @generated
   */
  public EClass getmdef_ContinuousObsModelType()
  {
    if (mdef_ContinuousObsModelTypeEClass == null)
    {
      mdef_ContinuousObsModelTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(9);
    }
    return mdef_ContinuousObsModelTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousObsModelType_Xmlns()
  {
        return (EReference)getmdef_ContinuousObsModelType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousObsModelType_SymbId()
  {
        return (EReference)getmdef_ContinuousObsModelType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousObsModelType_Var()
  {
        return (EReference)getmdef_ContinuousObsModelType().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousObsModelType_ErrorModel()
  {
        return (EReference)getmdef_ContinuousObsModelType().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousObsModelType_RandomEffect()
  {
        return (EReference)getmdef_ContinuousObsModelType().getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EClass getmdef_ErrorModel()
  {
    if (mdef_ErrorModelEClass == null)
    {
      mdef_ErrorModelEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(10);
    }
    return mdef_ErrorModelEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_ErrorModel_Xmlns()
  {
        return (EReference)getmdef_ErrorModel().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_ErrorModel_Var()
  {
        return (EReference)getmdef_ErrorModel().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_ErrorModel_FunctionArgument()
  {
        return (EReference)getmdef_ErrorModel().getEStructuralFeatures().get(2);
  }
  ...
  public EClass getmdef_RandomEffectType()
  {
    ...
    {
      mdef_RandomEffectTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(11);
    }
  ...
  public EClass getmdef_ParameterModelType()
  {
    ...
    {
      mdef_ParameterModelTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(12);
    }
  ...
  public EClass getmdef_CorrelationType()
  {
    ...
    {
      mdef_CorrelationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(13);
    }
   ...
   * @generated
   */
  public EClass getmdef_Param1VarType()
  {
    if (mdef_Param1VarTypeEClass == null)
    {
      mdef_Param1VarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(14);
    }
    return mdef_Param1VarTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_Param1VarType_Xmlns()
  {
        return (EReference)getmdef_Param1VarType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_Param1VarType_Block()
  {
        return (EReference)getmdef_Param1VarType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_Param1VarType_SymbId()
  {
        return (EReference)getmdef_Param1VarType().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EClass getmdef_Param2VarType()
  {
    if (mdef_Param2VarTypeEClass == null)
    {
      mdef_Param2VarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(15);
    }
    return mdef_Param2VarTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_Param2VarType_Xmlns()
  {
        return (EReference)getmdef_Param2VarType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_Param2VarType_Block()
  {
        return (EReference)getmdef_Param2VarType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_Param2VarType_SymbId()
  {
        return (EReference)getmdef_Param2VarType().getEStructuralFeatures().get(2);
  }
  ...
  public EClass getmdefCovarianceType()
  {
    ...
    {
      mdefCovarianceTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(16);
    }
  ...
  public EClass getmdef_CorrelationCoefficientType()
  {
    ...
    {
      mdef_CorrelationCoefficientTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(17);
    }
  ...
  public EClass getmdef_CovariateModelType()
  {
    ...
    {
      mdef_CovariateModelTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(18);
    }
  ...
  public EClass getmdef_ParameterType()
  {
    ...
    {
      mdef_ParameterTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(19);
    }
  ...
  public EClass getmdef_CovariateVariabilityType()
  {
    ...
    {
      mdef_CovariateVariabilityTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(20);
    }
  ...
  public EClass getmdef_transformation()
  {
    ...
    {
      mdef_transformationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(21);
    }
  ...
  public EClass getmdef_CategoricalType()
  {
    ...
    {
      mdef_CategoricalTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(22);
    }
   ...
   * @generated
   */
  public EClass getmdef_ContinuousCovariateType()
  {
    if (mdef_ContinuousCovariateTypeEClass == null)
    {
      mdef_ContinuousCovariateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(23);
    }
    return mdef_ContinuousCovariateTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousCovariateType_Xmlns()
  {
        return (EReference)getmdef_ContinuousCovariateType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousCovariateType_Distribution()
  {
        return (EReference)getmdef_ContinuousCovariateType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_ContinuousCovariateType_Transformation()
  {
        return (EReference)getmdef_ContinuousCovariateType().getEStructuralFeatures().get(2);
  }
  ...
  public EClass getmdef_TransformationType()
  {
    ...
    {
      mdef_TransformationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(24);
    }
   ...
   * @generated
   */
  public EReference getmdef_TransformationType_Xmlns()
  {
  ...
  {
        return (EReference)getmdef_TransformationType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmdef_VariabilityLevelDefnType()
  {
    ...
    {
      mdef_VariabilityLevelDefnTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(25);
    }
  ...
  public EClass getmdef_ImportType()
  {
    ...
    {
      mdef_ImportTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(26);
    }
  ...
  {
        return (EReference)getmdef_ImportType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmdef_ImportType().getEStructuralFeatures().get(1);
  }
  ...
  {
        return (EReference)getmdef_ImportType().getEStructuralFeatures().get(2);
  }
  ...
  {
        return (EAttribute)getmdef_ImportType().getEStructuralFeatures().get(3);
  }
  ...
  public EClass getmdef_ImportLinkType()
  {
    ...
    {
      mdef_ImportLinkTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(27);
    }
  ...
  {
        return (EReference)getmdef_ImportLinkType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmdef_ImportLinkType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmdef_ImportResourceTypeType()
  {
    ...
    {
      mdef_ImportResourceTypeTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(28);
    }
  ...
  public EClass getmdef_CovariateType()
  {
    ...
    {
      mdef_CovariateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(29);
    }
  ...
  public EClass getmdef_FixedEffectType()
  {
    ...
    {
      mdef_FixedEffectTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(30);
    }
  ...
  public EClass getmdef_CategoryType()
  {
    ...
    {
      mdef_CategoryTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(31);
    }
  ...
  public EClass getmdef_ProbabilityType()
  {
    ...
    {
      mdef_ProbabilityTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(32);
    }
   ...
   * @generated
   */
  public EClass getmdef_ParameterRandomEffectType()
  {
    if (mdef_ParameterRandomEffectTypeEClass == null)
    {
      mdef_ParameterRandomEffectTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(33);
    }
    return mdef_ParameterRandomEffectTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmdef_ParameterRandomEffectType_Xmlns()
  {
        return (EReference)getmdef_ParameterRandomEffectType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmdef_ParameterRandomEffectType_LevelId()
  {
        return (EReference)getmdef_ParameterRandomEffectType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmdef_ParameterRandomEffectType_Name()
  {
        return (EReference)getmdef_ParameterRandomEffectType().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getmdef_ParameterRandomEffectType_SymbId()
  {
        return (EReference)getmdef_ParameterRandomEffectType().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getmdef_ParameterRandomEffectType_Distribution()
  {
        return (EReference)getmdef_ParameterRandomEffectType().getEStructuralFeatures().get(4);
  }
  ...
  public EClass getmdef_InitialConditionType()
  {
    ...
    {
      mdef_InitialConditionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(34);
    }
  ...
  public EClass getmsteps_ModelingSteps()
  {
    ...
    {
      msteps_ModelingStepsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(35);
    }
   ...
   * @generated
   */
  public EReference getmsteps_ModelingSteps_Expr()
  {
   ...
   * @generated
   */
  public EClass getmsteps_ModelingStepsContent()
  {
    if (msteps_ModelingStepsContentEClass == null)
    {
      msteps_ModelingStepsContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(36);
    }
    return msteps_ModelingStepsContentEClass;
  }
   ...
   * @generated
   */
  public EReference getmsteps_ModelingStepsContent_EstimationStep()
  {
        return (EReference)getmsteps_ModelingStepsContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ModelingStepsContent_SimulationStep()
  {
        return (EReference)getmsteps_ModelingStepsContent().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmsteps_StepDependenciesType()
  {
    ...
    {
      msteps_StepDependenciesTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(37);
    }
  ...
  public EClass getmsteps_StepType()
  {
    ...
    {
      msteps_StepTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(38);
    }
  ...
  {
        return (EReference)getmsteps_StepType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmsteps_StepType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmsteps_DependantStepType()
  {
    ...
    {
      msteps_DependantStepTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(39);
    }
  ...
  {
        return (EReference)getmsteps_DependantStepType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmsteps_DependantStepType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmsteps_EstimationStep()
  {
    ...
    {
      msteps_EstimationStepEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(40);
    }
  ...
  public EClass getmsteps_ParametersToEstimateType()
  {
    ...
    {
      msteps_ParametersToEstimateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(41);
    }
  ...
  public EClass getmSteps_VariableEstimateType()
  {
    ...
    {
      mSteps_VariableEstimateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(42);
    }
  ...
  public EClass getmSteps_fixed()
  {
    ...
    {
      mSteps_fixedEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(43);
    }
  ...
  public EClass getmSteps_UpperBoundType()
  {
    ...
    {
      mSteps_UpperBoundTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(44);
    }
  ...
  public EClass getmSteps_LowerBoundType()
  {
    ...
    {
      mSteps_LowerBoundTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(45);
    }
  ...
  public EClass getmSteps_InitialEstimateType()
  {
    ...
    {
      mSteps_InitialEstimateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(46);
    }
  ...
  public EClass getmsteps_ObjectiveDataSetType()
  {
    ...
    {
      msteps_ObjectiveDataSetTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(47);
    }
  ...
  {
        return (EReference)getmsteps_ObjectiveDataSetType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmsteps_ObjectiveDataSetType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getmsteps_ColumnMappingType()
  {
    if (msteps_ColumnMappingTypeEClass == null)
    {
      msteps_ColumnMappingTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(48);
    }
    return msteps_ColumnMappingTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingType_Xmlns()
  {
        return (EReference)getmsteps_ColumnMappingType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getmsteps_ColumnMappingType_Columnname()
  {
        return (EAttribute)getmsteps_ColumnMappingType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingType_Expr()
  {
        return (EReference)getmsteps_ColumnMappingType().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingType_Restriction()
  {
        return (EReference)getmsteps_ColumnMappingType().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EClass getmsteps_ColumnMappingTypeContent()
  {
    if (msteps_ColumnMappingTypeContentEClass == null)
    {
      msteps_ColumnMappingTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(49);
    }
    return msteps_ColumnMappingTypeContentEClass;
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_Var()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_UseVariabilityLevel()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_UseVariabilityNode()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_DoseVar()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_TargetVar()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_Assign()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(5);
  }
   ...
   * @generated
   */
  public EReference getmsteps_ColumnMappingTypeContent_Output()
  {
        return (EReference)getmsteps_ColumnMappingTypeContent().getEStructuralFeatures().get(6);
  }
  ...
  public EClass getmsteps_OutputType()
  {
    ...
    {
      msteps_OutputTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(50);
    }
  ...
  public EClass getmsteps_AssignType()
  {
    ...
    {
      msteps_AssignTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(51);
    }
  ...
  public EClass getmsteps_TargetVarType()
  {
    ...
    {
      msteps_TargetVarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(52);
    }
  ...
  public EClass getmsteps_UseVariabilityLevel()
  {
    ...
    {
      msteps_UseVariabilityLevelEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(53);
    }
  ...
  {
        return (EReference)getmsteps_UseVariabilityLevel().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmsteps_UseVariabilityLevel().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmsteps_UseVariabilityNode()
  {
    ...
    {
      msteps_UseVariabilityNodeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(54);
    }
  ...
  public EClass getmsteps_SimulationStep()
  {
    ...
    {
      msteps_SimulationStepEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(55);
    }
  ...
  public EClass getmsteps_SimDataSetType()
  {
    ...
    {
      msteps_SimDataSetTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(56);
    }
  ...
  {
        return (EReference)getmsteps_SimDataSetType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getmsteps_SimDataSetType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getmsteps_ObservationsType()
  {
    ...
    {
      msteps_ObservationsTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(57);
    }
  ...
  public EClass getmsteps_WriteToType()
  {
    ...
    {
      msteps_WriteToTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(58);
    }
  ...
  public EClass getmsteps_TimepointsType()
  {
    ...
    {
      msteps_TimepointsTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(59);
    }
  ...
  public EClass getmsteps_InitialValueType()
  {
    ...
    {
      msteps_InitialValueTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(60);
    }
   ...
   * @generated
   */
  public EReference getmsteps_InitialValueType_Block()
  {
   ...
   * @generated
   */
  public EReference getmsteps_InitialValueType_Expr()
  {
        return (EReference)getmsteps_InitialValueType().getEStructuralFeatures().get(3);
  }
  ...
  public EClass getmsteps_EstimationOperationType()
  {
    ...
    {
      msteps_EstimationOperationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(61);
    }
  ...
  public EClass getdesign_TrialDesignType()
  {
    ...
    {
      design_TrialDesignTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(62);
    }
  ...
  public EClass getdesign_GroupType()
  {
    ...
    {
      design_GroupTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(63);
    }
   ...
   * @generated
   */
  public EReference getdesign_GroupType_Expr()
  {
   ...
   * @generated
   */
  public EClass getdesign_GroupTypeContent()
  {
    if (design_GroupTypeContentEClass == null)
    {
      design_GroupTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(64);
    }
    return design_GroupTypeContentEClass;
  }
   ...
   * @generated
   */
  public EReference getdesign_GroupTypeContent_TreatmentEpochRef()
  {
        return (EReference)getdesign_GroupTypeContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getdesign_GroupTypeContent_Washout()
  {
        return (EReference)getdesign_GroupTypeContent().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getdesign_IdividualsType()
  {
    ...
    {
      design_IdividualsTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(65);
    }
  ...
  public EClass getdesign_WashoutType()
  {
    ...
    {
      design_WashoutTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(66);
    }
  ...
  public EClass getdesign_TreatmentEpohType()
  {
    ...
    {
      design_TreatmentEpohTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(67);
    }
   ...
   * @generated
   */
  public EReference getdesign_TreatmentEpohType_Id()
  {
  ...
  public EClass getdesign_OccasionType()
  {
    ...
    {
      design_OccasionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(68);
    }
  ...
  public EClass getdesign_BeginType()
  {
    ...
    {
      design_BeginTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(69);
    }
  ...
  public EClass getdesign_EndType()
  {
    ...
    {
      design_EndTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(70);
    }
  ...
  public EClass getdesign_StartType()
  {
    ...
    {
      design_StartTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(71);
    }
  ...
  public EClass getdesign_TreatmentRefType()
  {
    ...
    {
      design_TreatmentRefTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(72);
    }
  ...
  {
        return (EReference)getdesign_TreatmentRefType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getdesign_TreatmentRefType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getdesign_TreatmentEpochRefType()
  {
    if (design_TreatmentEpochRefTypeEClass == null)
    {
      design_TreatmentEpochRefTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(73);
    }
    return design_TreatmentEpochRefTypeEClass;
  }
   ...
   * @generated
   */
  public EReference getdesign_TreatmentEpochRefType_Xmlns()
  {
        return (EReference)getdesign_TreatmentEpochRefType().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getdesign_TreatmentEpochRefType_IdRef()
  {
        return (EAttribute)getdesign_TreatmentEpochRefType().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getdesign_TreatmentType()
  {
    ...
    {
      design_TreatmentTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(74);
    }
   ...
   * @generated
   */
  public EReference getdesign_TreatmentType_Id()
  {
  ...
  public EClass getdesign_DosingRegimenType()
  {
    ...
    {
      design_DosingRegimenTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(75);
    }
  ...
  public EClass getdesign_InfusionType()
  {
    ...
    {
      design_InfusionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(76);
    }
  ...
  public EClass getdesign_DurationType()
  {
    ...
    {
      design_DurationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(77);
    }
  ...
  public EClass getdesign_BolusType()
  {
    ...
    {
      design_BolusTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(78);
    }
  ...
  public EClass getdesign_DosingTimesType()
  {
    ...
    {
      design_DosingTimesTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(79);
    }
   ...
   * @generated
   */
  public EClass getdesign_DosingTimesTypeContent()
  {
    if (design_DosingTimesTypeContentEClass == null)
    {
      design_DosingTimesTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(80);
    }
    return design_DosingTimesTypeContentEClass;
  }
   ...
   * @generated
   */
  public EReference getdesign_DosingTimesTypeContent_Sequence()
  {
        return (EReference)getdesign_DosingTimesTypeContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getdesign_DosingTimesTypeContent_Scalar()
  {
        return (EReference)getdesign_DosingTimesTypeContent().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getdesign_SteadyStateType()
  {
    ...
    {
      design_SteadyStateTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(81);
    }
  ...
  public EClass getdesign_DosingStartType()
  {
    ...
    {
      design_DosingStartTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(82);
    }
  ...
  public EClass getdesign_DosingPeriodType()
  {
    ...
    {
      design_DosingPeriodTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(83);
    }
  ...
  public EClass getdesign_DoseAmountType()
  {
    ...
    {
      design_DoseAmountTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(84);
    }
  ...
  public EClass getdesign_DosingVariableType()
  {
    ...
    {
      design_DosingVariableTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(85);
    }
   ...
   * @generated
   */
  public EReference getdesign_DosingVariableType_Expr()
  {
   ...
   * @generated
   */
  public EClass getdesign_DosingVariableTypeContent()
  {
    if (design_DosingVariableTypeContentEClass == null)
    {
      design_DosingVariableTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(86);
    }
    return design_DosingVariableTypeContentEClass;
  }
   ...
   * @generated
   */
  public EReference getdesign_DosingVariableTypeContent_DoseVar()
  {
        return (EReference)getdesign_DosingVariableTypeContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getdesign_DosingVariableTypeContent_TargetVar()
  {
        return (EReference)getdesign_DosingVariableTypeContent().getEStructuralFeatures().get(1);
  }
  ...
  public EClass getdesign_AmountType()
  {
    ...
    {
      design_AmountTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(87);
    }
  ...
  public EClass getdesign_TargetVarType()
  {
    ...
    {
      design_TargetVarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(88);
    }
  ...
  public EClass getdesign_DoseVarType()
  {
    ...
    {
      design_DoseVarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(89);
    }
  ...
  public EClass getuncert_DistributionType()
  {
    ...
    {
      uncert_DistributionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(90);
    }
   ...
   * @generated
   */
  public EReference getuncert_DistributionType_Expr()
  {
   ...
   * @generated
   */
  public EClass getuncert_DistributionTypeContent()
  {
    if (uncert_DistributionTypeContentEClass == null)
    {
      uncert_DistributionTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(91);
    }
    return uncert_DistributionTypeContentEClass;
  }
   ...
   * @generated
   */
  public EReference getuncert_DistributionTypeContent_Normal()
  {
        return (EReference)getuncert_DistributionTypeContent().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getuncert_DistributionTypeContent_PDF()
  {
        return (EReference)getuncert_DistributionTypeContent().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getuncert_DistributionTypeContent_Poison()
  {
        return (EReference)getuncert_DistributionTypeContent().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getuncert_DistributionTypeContent_Student()
  {
        return (EReference)getuncert_DistributionTypeContent().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getuncert_DistributionTypeContent_Uniform()
  {
        return (EReference)getuncert_DistributionTypeContent().getEStructuralFeatures().get(4);
  }
  ...
  public EClass getuncert_Normal()
  {
    ...
    {
      uncert_NormalEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(92);
    }
  ...
  public EClass getuncert_CoefficientOfVariance()
  {
    ...
    {
      uncert_CoefficientOfVarianceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(93);
    }
  ...
  public EClass getuncert_StdDev()
  {
    ...
    {
      uncert_StdDevEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(94);
    }
  ...
  public EClass getuncert_DistributionParamType()
  {
    ...
    {
      uncert_DistributionParamTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(95);
    }
  ...
  public EClass getuncert_MeanParamType()
  {
    ...
    {
      uncert_MeanParamTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(96);
    }
  ...
  public EClass getuncert_Mean()
  {
    ...
    {
      uncert_MeanEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(97);
    }
  ...
  public EClass getuncert_Variance()
  {
    ...
    {
      uncert_VarianceEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(98);
    }
  ...
  public EClass getuncert_PDF()
  {
    ...
    {
      uncert_PDFEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(99);
    }
  ...
  public EClass getuncert_ParameterDefinitionType()
  {
    ...
    {
      uncert_ParameterDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(100);
    }
  ...
  public EClass getuncert_Poison()
  {
    ...
    {
      uncert_PoisonEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(101);
    }
  ...
  public EClass getuncert_Rate()
  {
    ...
    {
      uncert_RateEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(102);
    }
  ...
  public EClass getuncert_Student_t()
  {
    ...
    {
      uncert_Student_tEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(103);
    }
  ...
  public EClass getuncertDegreesOfFreedom()
  {
    ...
    {
      uncertDegreesOfFreedomEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(104);
    }
  ...
  public EClass getuncert_Scale()
  {
    ...
    {
      uncert_ScaleEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(105);
    }
  ...
  public EClass getuncert_Location()
  {
    ...
    {
      uncert_LocationEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(106);
    }
  ...
  public EClass getuncert_Uniform()
  {
    ...
    {
      uncert_UniformEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(107);
    }
  ...
  public EClass getMath_EquationType()
  {
    ...
    {
      math_EquationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(108);
    }
  ...
  public EClass getMath_EquationTypeContent()
  {
    ...
    {
      math_EquationTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(109);
    }
  ...
  public EClass getMath_ScalarType()
  {
    ...
    {
      math_ScalarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(110);
    }
  ...
  public EClass getMath_VarType()
  {
    ...
    {
      math_VarTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(111);
    }
  ...
  public EClass getMath_BinopType()
  {
    ...
    {
      math_BinopTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(112);
    }
  ...
  public EClass getMath_UniopType()
  {
    ...
    {
      math_UniopTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(113);
    }
  ...
  public EClass getMath_ExprType()
  {
    ...
    {
      math_ExprTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(114);
    }
  ...
  public EClass getMath_ConstantType()
  {
    ...
    {
      math_ConstantTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(115);
    }
  ...
  public EClass getMath_FunctionCallType()
  {
    ...
    {
      math_FunctionCallTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(116);
    }
  ...
  public EClass getMath_FunctionArgumentType()
  {
    ...
    {
      math_FunctionArgumentTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(117);
    }
  ...
  public EClass getMath_FuncExprType()
  {
    ...
    {
      math_FuncExprTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(118);
    }
  ...
  public EClass getMath_PiecewiseType()
  {
    ...
    {
      math_PiecewiseTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(119);
    }
  ...
  public EClass getMath_PieceType()
  {
    ...
    {
      math_PieceTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(120);
    }
  ...
  public EClass getMath_ConditionType()
  {
    ...
    {
      math_ConditionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(121);
    }
  ...
  public EClass getMath_LogicBaseType()
  {
    ...
    {
      math_LogicBaseTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(122);
    }
   ...
   * @generated
   */
  public EReference getMath_LogicBaseType_Otherwise()
  {
   ...
   * @generated
   */
  public EClass getMath_Otherwise()
  {
    if (math_OtherwiseEClass == null)
    {
      math_OtherwiseEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(123);
    }
    return math_OtherwiseEClass;
  }
   ...
   * @generated
   */
  public EReference getMath_Otherwise_Xmlns()
  {
        return (EReference)getMath_Otherwise().getEStructuralFeatures().get(0);
  }
  ...
  public EClass getMath_LogicExprType()
  {
    ...
    {
      math_LogicExprTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(124);
    }
   ...
   * @generated
   */
  public EReference getMath_LogicExprType_Scalar()
  {
  ...
  {
        return (EReference)getMath_LogicExprType().getEStructuralFeatures().get(6);
  }
  ...
  public EClass getMath_StringType()
  {
    ...
    {
      math_StringTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(125);
    }
  ...
  public EClass getMath_TRUE()
  {
    ...
    {
      math_TRUEEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(126);
    }
  ...
  public EClass getMath_FALSE()
  {
    ...
    {
      math_FALSEEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(127);
    }
  ...
  public EClass getMath_LogicBinopType()
  {
    ...
    {
      math_LogicBinopTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(128);
    }
  ...
  public EClass getMath_LogicUniopType()
  {
    ...
    {
      math_LogicUniopTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(129);
    }
  ...
  public EClass getMath_BinopName()
  {
    ...
    {
      math_BinopNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(130);
    }
  ...
  public EClass getMath_UniopName()
  {
    ...
    {
      math_UniopNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(131);
    }
  ...
  public EClass getMath_LogicUniopName()
  {
    ...
    {
      math_LogicUniopNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(132);
    }
  ...
  public EClass getMath_LogicBinopName()
  {
    ...
    {
      math_LogicBinopNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(133);
    }
  ...
  public EClass getMath_ConstantName()
  {
    ...
    {
      math_ConstantNameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(134);
    }
  ...
  public EClass getMath_symbId()
  {
    ...
    {
      math_symbIdEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(135);
    }
  ...
  public EClass getMath_id()
  {
    ...
    {
      math_idEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(136);
    }
  ...
  public EClass getMath_block()
  {
    ...
    {
      math_blockEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(137);
    }
  ...
  public EClass getMath_EstimationOperationType()
  {
    ...
    {
      math_EstimationOperationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(138);
    }
  ...
  public EClass getct_ReplicatesType()
  {
    ...
    {
      ct_ReplicatesTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(139);
    }
  ...
  public EClass getct_AnnotationType()
  {
    ...
    {
      ct_AnnotationTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(140);
    }
  ...
  public EClass getct_Rhs()
  {
    ...
    {
      ct_RhsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(141);
    }
    return ct_RhsEClass;
  }
  ...
  public EClass getct_DataSetType()
  {
    ...
    {
      ct_DataSetTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(142);
    }
  ...
  public EClass getct_DefinitionType()
  {
    ...
    {
      ct_DefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(143);
    }
  ...
  public EClass getct_DefinitionRhsType()
  {
    ...
    {
      ct_DefinitionRhsTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(144);
    }
  ...
  public EClass getct_ColumnType()
  {
    ...
    {
      ct_ColumnTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(145);
    }
   ...
   * @generated
   */
  public EAttribute getct_ColumnType_ColumnNum()
  {
  ...
  {
        return (EAttribute)getct_ColumnType().getEStructuralFeatures().get(2);
  }
  ...
  public EClass getct_ExternalSourceType()
  {
    ...
    {
      ct_ExternalSourceTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(146);
    }
  ...
  {
        return (EReference)getct_ExternalSourceType().getEStructuralFeatures().get(0);
  }
  ...
  {
        return (EAttribute)getct_ExternalSourceType().getEStructuralFeatures().get(1);
  }
  ...
  {
        return (EReference)getct_ExternalSourceType().getEStructuralFeatures().get(2);
  }
  ...
  {
        return (EAttribute)getct_ExternalSourceType().getEStructuralFeatures().get(4);
  }
  ...
  public EClass getct_RowType()
  {
    ...
    {
      ct_RowTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(147);
    }
  ...
  public EClass getct_RowTypeContent()
  {
    ...
    {
      ct_RowTypeContentEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(148);
    }
   ...
   * @generated
   */
  public EReference getct_RowTypeContent_Null()
  {
        return (EReference)getct_RowTypeContent().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getct_NullCellType()
  {
    if (ct_NullCellTypeEClass == null)
    {
      ct_NullCellTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(149);
    }
    return ct_NullCellTypeEClass;
  }
   ...
   * @generated
   */
  public EAttribute getct_NullCellType_Null()
  {
        return (EAttribute)getct_NullCellType().getEStructuralFeatures().get(0);
  }
  ...
  public EClass getct_CellType()
  {
    ...
    {
      ct_CellTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(150);
    }
  ...
  public EClass getct_InternalSourceType()
  {
    ...
    {
      ct_InternalSourceTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(151);
    }
  ...
  public EClass getct_VectorType()
  {
    ...
    {
      ct_VectorTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(152);
    }
  ...
  public EClass getct_SequenceType()
  {
    ...
    {
      ct_SequenceTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(153);
    }
   ...
   * @generated
   */
  public EAttribute getct_SequenceType_Begin()
  {
        return (EAttribute)getct_SequenceType().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getct_SequenceType_End()
  {
        return (EAttribute)getct_SequenceType().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EAttribute getct_SequenceType_Stepwise()
  {
        return (EAttribute)getct_SequenceType().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EAttribute getct_SequenceType_Repetition()
  {
        return (EAttribute)getct_SequenceType().getEStructuralFeatures().get(4);
  }
  ...
  public EClass getct_VariableDefinitionType()
  {
    ...
    {
      ct_VariableDefinitionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(154);
    }
  ...
  public EClass getct_RestrictionType()
  {
    ...
    {
      ct_RestrictionTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(155);
    }
  ...
  public EClass getct_ScalarRhs()
  {
    ...
    {
      ct_ScalarRhsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(156);
    }
  ...
  public EClass getct_independentVar()
  {
    ...
    {
      ct_independentVarEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(157);
    }
  ...
  public EClass getct_levelId()
  {
    ...
    {
      ct_levelIdEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(158);
    }
  ...
  public EClass getct_name()
  {
    ...
    {
      ct_nameEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(159);
    }
  ...
  public EClass getct_symbId()
  {
    ...
    {
      ct_symbIdEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(160);
    }
  ...
  public EClass getct_id()
  {
    if (ct_idEClass == null)
    {
      ct_idEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(161);
    }
    return ct_idEClass;
  }
  ...
  public EClass getct_symbolType()
  {
    ...
    {
      ct_symbolTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(162);
    }
  ...
  public EClass getct_block()
  {
    ...
    {
      ct_blockEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(163);
    }
  ...
  public EClass getct_writtenVersion()
  {
    ...
    {
      ct_writtenVersionEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(164);
    }
  ...
  public EClass getct_Decimal_Value()
  {
    ...
    {
      ct_Decimal_ValueEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(165);
    }
  ...
  public EClass getct_String_Value()
  {
    ...
    {
      ct_String_ValueEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(166);
    }
  ...
  public EClass getct_catId()
  {
    ...
    {
      ct_catIdEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(167);
    }
  ...
  public EClass getct_SymbolTypeType()
  {
    ...
    {
      ct_SymbolTypeTypeEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(168);
    }
   ...
   * @generated
   */
  public EClass getXS_xmlns()
  {
    if (xS_xmlnsEClass == null)
    {
      xS_xmlnsEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(169);
    }
    return xS_xmlnsEClass;
  }
   ...
   * @generated
   */
  public EAttribute getXS_xmlns_Location()
  {
        return (EAttribute)getXS_xmlns().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getMml_FuncParameterDefinitionTyp()
  {
    if (mml_FuncParameterDefinitionTypEClass == null)
    {
      mml_FuncParameterDefinitionTypEClass = (EClass)EPackage.Registry.INSTANCE.getEPackage(PharmMLPackage.eNS_URI).getEClassifiers().get(170);
    }
    return mml_FuncParameterDefinitionTypEClass;
  }
   ...
   * @generated
   */
  public EReference getMml_FuncParameterDefinitionTyp_Xmlns()
  {
        return (EReference)getMml_FuncParameterDefinitionTyp().getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getMml_FuncParameterDefinitionTyp_SumbId()
  {
        return (EReference)getMml_FuncParameterDefinitionTyp().getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getMml_FuncParameterDefinitionTyp_SymbolType()
  {
        return (EReference)getMml_FuncParameterDefinitionTyp().getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getMml_FuncParameterDefinitionTyp_Decsription()
  {
        return (EReference)getMml_FuncParameterDefinitionTyp().getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public PharmMLFactory getPharmMLFactory()
  {
    return (PharmMLFactory)getEFactoryInstance();
  }
  ...
  protected void fixInstanceClass(EClassifier eClassifier)
  {
    ...
    {
      eClassifier.setInstanceClassName("eu.ddmore.pml.pharmML." + eClassifier.getName());
