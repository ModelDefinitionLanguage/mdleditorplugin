 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.design_TreatmentRefTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.design_TreatmentRefTypeImpl#getIdRef <em>Id Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class design_TreatmentRefTypeImpl extends MinimalEObjectImpl.Container implements design_TreatmentRefType
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getdesign_TreatmentRefType();
  }
  ...
  public EList<XS_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<XS_xmlns>(XS_xmlns.class, this, PharmMLPackage.DESIGN_TREATMENT_REF_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public void setIdRef(String newIdRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.DESIGN_TREATMENT_REF_TYPE__ID_REF, oldIdRef, idRef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmMLPackage.DESIGN_TREATMENT_REF_TYPE__XMLNS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.DESIGN_TREATMENT_REF_TYPE__XMLNS:
        return getXmlns();
      case PharmMLPackage.DESIGN_TREATMENT_REF_TYPE__ID_REF:
        return getIdRef();
    }
