 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_symbolTypeImpl#getSymbolType <em>Symbol Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_symbolTypeImpl extends MinimalEObjectImpl.Container implements ct_symbolType
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_symbolType();
  }
  ...
  public NotificationChain basicSetSymbolType(ct_SymbolTypeType newSymbolType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE__SYMBOL_TYPE, oldSymbolType, newSymbolType);
  ...
  public void setSymbolType(ct_SymbolTypeType newSymbolType)
  {
    if (newSymbolType != symbolType)
    {
      ...
      if (symbolType != null)
        msgs = ((InternalEObject)symbolType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PharmMLPackage.CT_SYMBOL_TYPE__SYMBOL_TYPE, null, msgs);
      if (newSymbolType != null)
        msgs = ((InternalEObject)newSymbolType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PharmMLPackage.CT_SYMBOL_TYPE__SYMBOL_TYPE, null, msgs);
      msgs = basicSetSymbolType(newSymbolType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMBOL_TYPE__SYMBOL_TYPE, newSymbolType, newSymbolType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_SYMBOL_TYPE__SYMBOL_TYPE:
