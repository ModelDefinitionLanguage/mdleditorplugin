 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.msteps_DependantStepTypeImpl#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.msteps_DependantStepTypeImpl#getIdRef <em>Id Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class msteps_DependantStepTypeImpl extends MinimalEObjectImpl.Container implements msteps_DependantStepType
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getmsteps_DependantStepType();
  }
  ...
  public EList<XS_xmlns> getXmlns()
  {
    if (xmlns == null)
    {
      xmlns = new EObjectContainmentEList<XS_xmlns>(XS_xmlns.class, this, PharmMLPackage.MSTEPS_DEPENDANT_STEP_TYPE__XMLNS);
    }
    return xmlns;
  }
  ...
  public void setIdRef(String newIdRef)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.MSTEPS_DEPENDANT_STEP_TYPE__ID_REF, oldIdRef, idRef));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PharmMLPackage.MSTEPS_DEPENDANT_STEP_TYPE__XMLNS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.MSTEPS_DEPENDANT_STEP_TYPE__XMLNS:
        return getXmlns();
      case PharmMLPackage.MSTEPS_DEPENDANT_STEP_TYPE__ID_REF:
        return getIdRef();
    }
