 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_blockImpl#getBlock <em>Block</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_blockImpl extends MinimalEObjectImpl.Container implements ct_block
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_block();
  }
  ...
  public void setBlock(String newBlock)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_BLOCK__BLOCK, oldBlock, block));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_BLOCK__BLOCK:
        return getBlock();
    }
