 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.mdef_ParameterTypeNameImpl#getLog <em>Log</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.mdef_ParameterTypeNameImpl#getLogit <em>Logit</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.mdef_ParameterTypeNameImpl#getNone <em>None</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class mdef_ParameterTypeNameImpl extends MinimalEObjectImpl.Container implements mdef_ParameterTypeName
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getmdef_ParameterTypeName();
  }
  ...
  public void setLog(String newLog)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__LOG, oldLog, log));
  }
  ...
  public void setLogit(String newLogit)
  {
    ...
    logit = newLogit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__LOGIT, oldLogit, logit));
  }
  ...
  public void setNone(String newNone)
  {
    ...
    none = newNone;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__NONE, oldNone, none));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__LOG:
        return getLog();
      case PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__LOGIT:
        return getLogit();
      case PharmMLPackage.MDEF_PARAMETER_TYPE_NAME__NONE:
        return getNone();
    }
