 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.Math_FALSEImpl#getFalse <em>False</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Math_FALSEImpl extends MinimalEObjectImpl.Container implements Math_FALSE
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getMath_FALSE();
  }
  ...
  public void setFalse(String newFalse)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.MATH_FALSE__FALSE, oldFalse, false_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.MATH_FALSE__FALSE:
        return getFalse();
    }
