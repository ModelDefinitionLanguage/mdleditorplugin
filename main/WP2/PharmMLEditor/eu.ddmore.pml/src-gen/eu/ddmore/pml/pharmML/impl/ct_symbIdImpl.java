 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.impl.ct_symbIdImpl#getSymbId <em>Symb Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ct_symbIdImpl extends MinimalEObjectImpl.Container implements ct_symbId
{
  ...
  {
    return PharmMLPackage.eINSTANCE.getct_symbId();
  }
  ...
  public void setSymbId(String newSymbId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PharmMLPackage.CT_SYMB_ID__SYMB_ID, oldSymbId, symbId));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PharmMLPackage.CT_SYMB_ID__SYMB_ID:
        return getSymbId();
    }
