 ...
 * <ul>
 *   <li>{@link eu.ddmore.pml.pharmML.design_BolusType#getXmlns <em>Xmlns</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.design_BolusType#getDoseAmount <em>Dose Amount</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.design_BolusType#getSteadyState <em>Steady State</em>}</li>
 *   <li>{@link eu.ddmore.pml.pharmML.design_BolusType#getDosingTimes <em>Dosing Times</em>}</li>
 * </ul>
 * </p>
 *
 * @see eu.ddmore.pml.pharmML.PharmMLPackage#getdesign_BolusType()
 * @model
 * @generated
 */
public interface design_BolusType extends EObject
{
   ...
   * @see eu.ddmore.pml.pharmML.PharmMLPackage#getdesign_BolusType_Xmlns()
   ...
   * @see eu.ddmore.pml.pharmML.PharmMLPackage#getdesign_BolusType_DoseAmount()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.ddmore.pml.pharmML.design_BolusType#getDoseAmount <em>Dose Amount</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.ddmore.pml.pharmML.PharmMLPackage#getdesign_BolusType_SteadyState()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.ddmore.pml.pharmML.design_BolusType#getSteadyState <em>Steady State</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see eu.ddmore.pml.pharmML.PharmMLPackage#getdesign_BolusType_DosingTimes()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link eu.ddmore.pml.pharmML.design_BolusType#getDosingTimes <em>Dosing Times</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
