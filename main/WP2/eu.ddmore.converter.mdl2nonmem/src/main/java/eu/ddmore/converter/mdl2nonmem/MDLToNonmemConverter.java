...
public class MDLToNonmemConverter extends MdlPrinterUtility implements ConverterProvider {
	...
	private CharSequence convertToNMTRAN(final Mcl m) {
		CharSequence _xblockexpression = null;
		{
			...
			_builder.newLineIfNotEmpty();
			{
				for (final DataObject d : dataObjects) {
					CharSequence _convertToNMTRAN = this.convertToNMTRAN(d,
							taskObjects);
				...
				for (final MclObject o_1 : _objects_1) {
					{
						...
						boolean _notEquals = (!Objects
								.equal(_modelObject, null));
						if (_notEquals) {
							ModelObject _modelObject_1 = o_1.getModelObject();
							CharSequence _convertToNMTRAN_1 = this
									.convertToNMTRAN(_modelObject_1);
			...
			_builder.newLineIfNotEmpty();
			{
				...
				for (final MclObject o_2 : _objects_2) {
					{
						ParameterObject _parameterObject = o_2
								.getParameterObject();
						boolean _notEquals_1 = (!Objects.equal(
								_parameterObject, null));
						if (_notEquals_1) {
							ParameterObject _parameterObject_1 = o_2
									.getParameterObject();
							CharSequence _convertToNMTRAN_2 = this
									.convertToNMTRAN(_parameterObject_1);
				...
				for (final MclObject o_3 : _objects_3) {
					{
						...
						boolean _notEquals_2 = (!Objects.equal(_taskObject,
								null));
						if (_notEquals_2) {
							TaskObject _taskObject_1 = o_3.getTaskObject();
							CharSequence _convertToNMTRAN_3 = this
									.convertToNMTRAN(_taskObject_1);
				...
				for (final MclObject o_4 : _objects_4) {
					{
						...
						boolean _notEquals_3 = (!Objects.equal(_modelObject_2,
								null));
						if (_notEquals_3) {
							ModelObject _modelObject_3 = o_4.getModelObject();
							CharSequence _printTABLE = this
									.printTABLE(_modelObject_3);
	...
	public CharSequence printPROB(final Mcl m) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			if (_or) {
				_builder.newLine();
				String _externalCodeStart = this
						.getExternalCodeStart("$PROBLEM");
				_builder.append(_externalCodeStart, "");
				_builder.newLineIfNotEmpty();
				String _externalCodeStart_1 = this
	...
	public CharSequence printABBREVIATED(final Mcl m) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			if (_isTargetDefined) {
				...
				boolean _isTargetDefined_1 = this
						.isTargetDefined("$ABBREVIATED");
				_or = (_isTargetDefined || _isTargetDefined_1);
			}
			if (_or) {
				_builder.newLine();
				...
				_builder.append(_externalCodeEnd, "");
				_builder.newLineIfNotEmpty();
				String _externalCodeEnd_1 = this
			...
			_builder.newLineIfNotEmpty();
			{
				if (isLibraryDefined) {
					...
					CharSequence _printERROR = this.printERROR(o,
							Boolean.valueOf(isErrorDefined));
					_builder.append(_printERROR, "");
					_builder.newLineIfNotEmpty();
				} else {
					CharSequence _printPRED = this.printPRED(o,
							Boolean.valueOf(isPKDefined),
							Boolean.valueOf(isErrorDefined));
	...
	public CharSequence printPRED(final ModelObject o,
			final Boolean isPKDefined, final Boolean isErrorDefined) {
		StringConcatenation _builder = new StringConcatenation();
		{
			boolean _or = false;
			if ((isPKDefined).booleanValue()) {
				...
				_or = ((isPKDefined).booleanValue() || (isErrorDefined)
						.booleanValue());
			}
			if (_or) {
				_builder.newLine();
	...
	public CharSequence printPKContent(final ModelObject o) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			for (final ModelObjectBlock b : _blocks) {
				{
					GroupVariablesBlock _groupVariablesBlock = b
							.getGroupVariablesBlock();
					boolean _notEquals = (!Objects.equal(_groupVariablesBlock,
							null));
					if (_notEquals) {
						{
							GroupVariablesBlock _groupVariablesBlock_1 = b
									.getGroupVariablesBlock();
							EList<GroupVariablesBlockStatement> _statements = _groupVariablesBlock_1
									.getStatements();
							for (final GroupVariablesBlockStatement st : _statements) {
								{
									BlockStatement _statement = st
											.getStatement();
									boolean _notEquals_1 = (!Objects.equal(
											_statement, null));
									if (_notEquals_1) {
										BlockStatement _statement_1 = st
												.getStatement();
										CharSequence _print = this
												.print(_statement_1);
				...
				{
					IndividualVariablesBlock _individualVariablesBlock = b
							.getIndividualVariablesBlock();
					boolean _notEquals_2 = (!Objects.equal(
							_individualVariablesBlock, null));
					if (_notEquals_2) {
						{
							IndividualVariablesBlock _individualVariablesBlock_1 = b
									.getIndividualVariablesBlock();
							EList<BlockStatement> _statements_1 = _individualVariablesBlock_1
									.getStatements();
				...
				{
					ModelPredictionBlock _modelPredictionBlock = b
							.getModelPredictionBlock();
					boolean _notEquals_3 = (!Objects.equal(
							_modelPredictionBlock, null));
					if (_notEquals_3) {
						{
							Set<Entry<Object, Object>> _entrySet = this.init_vars
									.entrySet();
							...
							if (_greaterThan) {
								...
								_builder.newLine();
								{
									Set<Entry<Object, Object>> _entrySet_1 = this.init_vars
											.entrySet();
					...
					if (_notEquals) {
						{
							...
							for (final GroupVariablesBlockStatement st : _statements) {
								{
									MixtureBlock _mixtureBlock = st
											.getMixtureBlock();
									boolean _notEquals_1 = (!Objects.equal(
											_mixtureBlock, null));
									if (_notEquals_1) {
										MixtureBlock _mixtureBlock_1 = st
												.getMixtureBlock();
										CharSequence _print = this
												.print(_mixtureBlock_1);
										_builder.append(_print, "");
										_builder.newLineIfNotEmpty();
									}
								}
			...
			for (final BlockStatement st : _statements) {
				...
				if (_notEquals) {
					...
					if (_notEquals_1) {
						...
						org.ddmore.mdl.mdl.List _list_1 = _expression_1
								.getList();
						Arguments _arguments = _list_1.getArguments();
						EList<Argument> _arguments_1 = _arguments
								.getArguments();
			...
			if (_greaterThan) {
				...
				for (final BlockStatement st_1 : _statements_1) {
					...
					if (_notEquals_2) {
						...
						Expression _expression_3 = _expression_2
								.getExpression();
						boolean _notEquals_3 = (!Objects.equal(_expression_3,
								null));
						if (_notEquals_3) {
							...
							AnyExpression _expression_4 = _symbol_5
									.getExpression();
							Expression _expression_5 = _expression_4
									.getExpression();
	...
	public CharSequence printErrorContent(final ModelObject o) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			for (final ModelObjectBlock mob : _blocks) {
				{
					ModelPredictionBlock _modelPredictionBlock = mob
							.getModelPredictionBlock();
					boolean _notEquals = (!Objects.equal(_modelPredictionBlock,
							null));
					if (_notEquals) {
						{
							ModelPredictionBlock _modelPredictionBlock_1 = mob
									.getModelPredictionBlock();
							EList<ModelPredictionBlockStatement> _statements = _modelPredictionBlock_1
									.getStatements();
							for (final ModelPredictionBlockStatement s : _statements) {
								{
									BlockStatement _statement = s
											.getStatement();
									boolean _notEquals_1 = (!Objects.equal(
											_statement, null));
									if (_notEquals_1) {
										BlockStatement _statement_1 = s
												.getStatement();
										CharSequence _print = this
												.print(_statement_1);
										_builder.append(_print, "");
				...
				{
					ObservationBlock _observationBlock = mob
							.getObservationBlock();
					boolean _notEquals_2 = (!Objects.equal(_observationBlock,
							null));
					if (_notEquals_2) {
						ObservationBlock _observationBlock_1 = mob
								.getObservationBlock();
				...
				}
				{
					...
					boolean _notEquals_3 = (!Objects.equal(_simulationBlock,
							null));
					if (_notEquals_3) {
						SimulationBlock _simulationBlock_1 = mob
								.getSimulationBlock();
				...
				}
				{
					...
					boolean _notEquals_4 = (!Objects.equal(_estimationBlock,
							null));
					if (_notEquals_4) {
						EstimationBlock _estimationBlock_1 = mob
								.getEstimationBlock();
			...
			for (final ModelObjectBlock b : _blocks) {
				{
					...
					if (_notEquals) {
						...
						_builder.newLineIfNotEmpty();
						{
							EList<ModelPredictionBlockStatement> _statements = bb
									.getStatements();
							for (final ModelPredictionBlockStatement s : _statements) {
								{
									...
									if (_notEquals_1) {
										{
											OdeBlock _odeBlock_1 = s
													.getOdeBlock();
											EList<BlockStatement> _statements_1 = _odeBlock_1
													.getStatements();
											for (final BlockStatement ss : _statements_1) {
												SymbolDeclaration x = ss
														.getSymbol();
												_builder.newLineIfNotEmpty();
												{
													boolean _notEquals_2 = (!Objects
															.equal(x, null));
													if (_notEquals_2) {
														{
															AnyExpression _expression = x
																	.getExpression();
															boolean _notEquals_3 = (!Objects
																	.equal(_expression,
																			null));
															if (_notEquals_3) {
																{
																	AnyExpression _expression_1 = x
																			.getExpression();
																	OdeList _odeList = _expression_1
																			.getOdeList();
																	boolean _notEquals_4 = (!Objects
																			.equal(_odeList,
																					null));
																	if (_notEquals_4) {
																		_builder.append("COMP(");
																		String _identifier = x
																				.getIdentifier();
																		_builder.append(
																				_identifier,
																				"");
									...
									if (_notEquals_1) {
										{
											...
											for (final BlockStatement ss : _statements_1) {
															...
															if (_notEquals_3) {
																{
																	AnyExpression _expression_1 = x
																			.getExpression();
																	Expression _expression_2 = _expression_1
																			.getExpression();
																	boolean _notEquals_4 = (!Objects
																			.equal(_expression_2,
																					null));
																...
																{
																	AnyExpression _expression_3 = x
																			.getExpression();
																	OdeList _odeList = _expression_3
																			.getOdeList();
																	boolean _notEquals_5 = (!Objects
																			.equal(_odeList,
																					null));
																	if (_notEquals_5) {
																		AnyExpression _expression_4 = x
																				.getExpression();
																		OdeList _odeList_1 = _expression_4
																				.getOdeList();
																		Arguments _arguments = _odeList_1
																				.getArguments();
																		String deriv = this
																				.getAttribute(
																						_arguments,
																		...
																		_builder.newLineIfNotEmpty();
																		{
																			...
																			if (_not) {
																				...
																				_builder.newLineIfNotEmpty();
																				{
																					Object _get = this.dadt_vars
																							.get(id);
																					boolean _notEquals_6 = (!Objects
																							.equal(_get,
																									null));
																					if (_notEquals_6) {
																						_builder.append("DADT(");
																						Object _get_1 = this.dadt_vars
																								.get(id);
																						_builder.append(
																								_get_1,
																								"");
												...
												{
													ConditionalStatement _statement = ss
															.getStatement();
													boolean _notEquals_7 = (!Objects
															.equal(_statement,
																	null));
													if (_notEquals_7) {
														ConditionalStatement _statement_1 = ss
																.getStatement();
														CharSequence _print_1 = this
																.print(_statement_1);
														_builder.append(
																_print_1, "");
														_builder.newLineIfNotEmpty();
			...
			for (final ModelObjectBlock b : _blocks) {
				{
					...
					boolean _notEquals = (!Objects.equal(_modelPredictionBlock,
							null));
					if (_notEquals) {
						ModelPredictionBlock _modelPredictionBlock_1 = b
								.getModelPredictionBlock();
						String _printSUBR = this
								.printSUBR(_modelPredictionBlock_1);
						_builder.append(_printSUBR, "");
						_builder.newLineIfNotEmpty();
					}
				}
	...
	public String printSUBR(final ModelPredictionBlock b) {
		...
		for (final ModelPredictionBlockStatement ss : _statements) {
			...
			if (_notEquals) {
				...
				EList<FunctionCallStatement> _statements_1 = _libraryBlock_1
						.getStatements();
				for (final FunctionCallStatement st : _statements_1) {
					{
						FunctionCall _expression = st.getExpression();
						FullyQualifiedSymbolName libraryRef = _expression
								.getIdentifier();
						HashMap<String, String> attributes = this
								.getExternalFunctionAttributes(libraryRef);
						String library = libraryRef.getIdentifier();
						boolean _notEquals_1 = (!Objects
								.equal(attributes, null));
						if (_notEquals_1) {
						...
						final String model = this.getAttribute(_arguments,
								"model");
						FunctionCall _expression_2 = st.getExpression();
						Arguments _arguments_1 = _expression_2.getArguments();
						final String trans = this.getAttribute(_arguments_1,
								"trans");
	...
	public CharSequence printTABLE(final ModelObject o) {
		StringConcatenation _builder = new StringConcatenation();
		{
			boolean _isOutputVariablesDefined = this
					.isOutputVariablesDefined(o);
		...
		_builder.newLineIfNotEmpty();
		{
			...
			for (final ModelObjectBlock b : _blocks) {
				{
					OutputVariablesBlock _outputVariablesBlock = b
							.getOutputVariablesBlock();
					boolean _notEquals = (!Objects.equal(_outputVariablesBlock,
							null));
					if (_notEquals) {
						OutputVariablesBlock bb = b.getOutputVariablesBlock();
						_builder.newLineIfNotEmpty();
						{
							EList<FullyQualifiedSymbolName> _variables = bb
									.getVariables();
							int _size = _variables.size();
							boolean _greaterThan = (_size > 0);
							if (_greaterThan) {
								{
									EList<FullyQualifiedSymbolName> _variables_1 = bb
											.getVariables();
									boolean _hasElements = false;
								...
								final String file = this
										.getTaskObjectName(_eResource);
								_builder.newLineIfNotEmpty();
			...
			for (final ParameterObjectBlock b : _blocks) {
				{
					...
					if (_notEquals) {
						{
							PriorParametersBlock _priorBlock_1 = b
									.getPriorBlock();
							EList<BlockStatement> _statements = _priorBlock_1
									.getStatements();
							for (final BlockStatement st : _statements) {
	...
	public CharSequence printTHETA(final ParameterObject obj) {
			...
			for (final ParameterObjectBlock b : _blocks) {
				{
					...
					boolean _notEquals = (!Objects
							.equal(_structuralBlock, null));
					if (_notEquals) {
						{
							StructuralBlock _structuralBlock_1 = b
									.getStructuralBlock();
							EList<ParameterDeclaration> _parameters = _structuralBlock_1
									.getParameters();
		...
		}
		{
			...
			if (_isTargetDefined_1) {
				_builder.newLine();
				ArrayList<String> _get_2 = this.externalCodeStart
						.get("$THETAR");
	...
	public CharSequence printOMEGA(final ParameterObject obj) {
		...
		_builder.append(_get, "");
		_builder.newLineIfNotEmpty();
		String _printVariabilityBlock = this.printVariabilityBlock(obj,
				"$OMEGA");
	...
	public String printVariabilityBlock(final ParameterObject obj,
		...
		for (final ParameterObjectBlock b : _blocks) {
			...
			if (_notEquals) {
				...
				EList<VariabilityBlockStatement> _statements = _variabilityBlock_1
						.getStatements();
				for (final VariabilityBlockStatement c : _statements) {
					{
						ParameterDeclaration _parameter = c.getParameter();
						boolean _notEquals_1 = (!Objects
								.equal(_parameter, null));
						if (_notEquals_1) {
							ParameterDeclaration _parameter_1 = c
									.getParameter();
							String tmp = this.printVariabilityParameter(
									_parameter_1, section);
						...
						boolean _notEquals_2 = (!Objects
								.equal(_diagBlock, null));
						if (_notEquals_2) {
							DiagBlock _diagBlock_1 = c.getDiagBlock();
							String _printDiag = this.printDiag(_diagBlock_1,
									section);
						...
						boolean _notEquals_3 = (!Objects.equal(_matrixBlock,
								null));
						if (_notEquals_3) {
							MatrixBlock _matrixBlock_1 = c.getMatrixBlock();
							String _printMatrix = this.printMatrix(
									_matrixBlock_1, section);
						...
						boolean _notEquals_4 = (!Objects
								.equal(_sameBlock, null));
						if (_notEquals_4) {
							SameBlock _sameBlock_1 = c.getSameBlock();
							String _printSame = this.printSame(_sameBlock_1,
									section);
				...
				if (_notEquals_2) {
					{
						...
						EList<FormalArgument> _arguments_1 = _parameters_1
								.getArguments();
				...
				for (final VariabilityBlockStatement c : _statements) {
					{
						...
						MatrixBlock _matrixBlock = c.getMatrixBlock();
						boolean _notEquals_2 = (!Objects.equal(_matrixBlock,
								null));
						if (_notEquals_2) {
							MatrixBlock _matrixBlock_1 = c.getMatrixBlock();
			...
			if (_notEquals) {
				Integer _xblockexpression_1 = null;
				{
					...
					if (_notEquals_1) {
						...
						EList<Argument> _arguments_1 = _parameters_1
								.getArguments();
						for (final Argument p : _arguments_1) {
							AnyExpression _expression = p.getExpression();
							boolean _notEquals_2 = (!Objects.equal(_expression,
									null));
							if (_notEquals_2) {
								int _plus = (k + 1);
								k = _plus;
								...
								if (_notEquals_3) {
									...
									boolean _notEquals_4 = (!Objects.equal(
											_get, null));
									if (_notEquals_4) {
										isOmega = true;
									}
									...
									boolean _notEquals_5 = (!Objects.equal(
											_get_1, null));
									if (_notEquals_5) {
										isSigma = true;
									}
					...
					if (isSigma) {
						Integer _put = this.namedSigmaBlocks.put(name,
								Integer.valueOf(k));
		...
		Integer _xblockexpression = null;
		{
			...
			if (_notEquals) {
				...
				for (final Argument p : _arguments_1) {
					...
					if (_notEquals_1) {
						String _identifier = p.getIdentifier();
						boolean _notEquals_2 = (!Objects.equal(_identifier,
								null));
						if (_notEquals_2) {
							String _identifier_1 = p.getIdentifier();
	...
	public String printVariabilityParameter(final ParameterDeclaration s,
			final String section) {
	...
	public CharSequence convertToNMTRAN(final DataObject d,
			final List<TaskObject> t) {
		StringConcatenation _builder = new StringConcatenation();
					...
					if (_notEquals) {
						{
							...
							EList<SymbolModification> _variables = _headerBlock_1
									.getVariables();
							boolean _hasElements = false;
							for (final SymbolModification st : _variables) {
								...
								{
									FullyQualifiedSymbolName _identifier = st
											.getIdentifier();
									boolean _isDrop = this.isDrop(_identifier,
											t);
									if (_isDrop) {
										FullyQualifiedSymbolName _identifier_1 = st
												.getIdentifier();
										String _str = this.toStr(_identifier_1);
										_builder.append(_str, "");
										_builder.append("=DROP");
									} else {
										FullyQualifiedSymbolName _identifier_2 = st
												.getIdentifier();
										String _str_1 = this
												.toStr(_identifier_2);
	...
	public boolean isDrop(final FullyQualifiedSymbolName id,
			final List<TaskObject> t) {
		for (final TaskObject tObj : t) {
			...
			for (final TaskObjectBlock b : _blocks) {
				...
				if (_notEquals) {
					...
					EList<DataBlockStatement> _statements = _dataBlock_1
							.getStatements();
					for (final DataBlockStatement block : _statements) {
						...
						if (_notEquals_1) {
							...
							EList<FullyQualifiedSymbolName> _symbols = _list
									.getSymbols();
							for (final FullyQualifiedSymbolName symbol : _symbols) {
								...
								boolean _equals = _identifier
										.equals(_identifier_1);
								if (_equals) {
									return true;
								}
							}
			...
			for (final DataObjectBlock b : _blocks) {
				{
					...
					if (_notEquals) {
						...
						_builder.newLineIfNotEmpty();
						{
							...
							EList<FileBlockStatement> _statements = _fileBlock_2
									.getStatements();
			...
			if (_equals) {
				...
				if (_notEquals_1) {
					...
					if (_notEquals_2) {
						...
						AnyExpression _expression_2 = _variable_4
								.getExpression();
						org.ddmore.mdl.mdl.List _list_1 = _expression_2
								.getList();
						Arguments _arguments = _list_1.getArguments();
		...
		for (final FileBlockStatement s : _statements) {
			...
			if (_equals) {
				...
				if (_notEquals) {
					...
					if (_notEquals_1) {
						SymbolDeclaration _variable_3 = s.getVariable();
						AnyExpression _expression_2 = _variable_3
								.getExpression();
						org.ddmore.mdl.mdl.List _list_1 = _expression_2
								.getList();
						Arguments _arguments = _list_1.getArguments();
	...
	public CharSequence convertToNMTRAN(final TaskObject o) {
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			for (final TaskObjectBlock b : _blocks) {
				{
					TaskFunctionDeclaration _functionDeclaration = b
							.getFunctionDeclaration();
					boolean _notEquals = (!Objects.equal(_functionDeclaration,
							null));
					if (_notEquals) {
						TaskFunctionDeclaration _functionDeclaration_1 = b
								.getFunctionDeclaration();
						final TaskFunctionBody body = _functionDeclaration_1
								.getFunctionBody();
						_builder.newLineIfNotEmpty();
						{
							...
							if (_notEquals_1) {
								{
									EList<TaskFunctionBlock> _blocks_1 = body
											.getBlocks();
									for (final TaskFunctionBlock bb : _blocks_1) {
										{
											EstimateTask _estimateBlock = bb
													.getEstimateBlock();
											boolean _notEquals_2 = (!Objects
													.equal(_estimateBlock, null));
											if (_notEquals_2) {
												EstimateTask _estimateBlock_1 = bb
														.getEstimateBlock();
												CharSequence _print = this
														.print(_estimateBlock_1);
												_builder.append(_print, "");
												_builder.newLineIfNotEmpty();
											}
										}
										{
											SimulateTask _simulateBlock = bb
													.getSimulateBlock();
											boolean _notEquals_3 = (!Objects
													.equal(_simulateBlock, null));
											if (_notEquals_3) {
												SimulateTask _simulateBlock_1 = bb
														.getSimulateBlock();
												CharSequence _print_1 = this
														.print(_simulateBlock_1);
												_builder.append(_print_1, "");
												_builder.newLineIfNotEmpty();
											}
										}
										{
											ExecuteTask _executeBlock = bb
													.getExecuteBlock();
											boolean _notEquals_4 = (!Objects
													.equal(_executeBlock, null));
											if (_notEquals_4) {
												ExecuteTask _executeBlock_1 = bb
														.getExecuteBlock();
												CharSequence _print_2 = this
														.print(_executeBlock_1);
												_builder.append(_print_2, "");
												_builder.newLineIfNotEmpty();
											}
										}
					...
					if (_notEquals) {
						{
							...
							for (final DataBlockStatement block : _statements) {
								{
									IgnoreList _ignoreList = block
											.getIgnoreList();
									boolean _notEquals_1 = (!Objects.equal(
											_ignoreList, null));
									if (_notEquals_1) {
										IgnoreList _ignoreList_1 = block
												.getIgnoreList();
										String _identifier = _ignoreList_1
												.getIdentifier();
										_builder.append(_identifier, "");
										_builder.append(" (");
										IgnoreList _ignoreList_2 = block
												.getIgnoreList();
										OrExpression _expression = _ignoreList_2
												.getExpression();
										String _commaSeparatedStr = this
												.toCommaSeparatedStr(_expression);
	...
	public CharSequence print(final SimulateTask b) {
		StringConcatenation _builder = new StringConcatenation();
		EList<BlockStatement> _statements = b.getStatements();
		boolean isInlineTargetDefined = this.isInlineTargetDefined(this.TARGET,
				_statements);
		_builder.newLineIfNotEmpty();
		{
					...
					for (final BlockStatement s : _statements_1) {
						{
							...
							if (_notEquals) {
								...
								CharSequence _printDefaultSimulate = this
										.printDefaultSimulate(_symbol_1);
					...
					for (final BlockStatement s_1 : _statements_2) {
						{
							...
							boolean _notEquals_1 = (!Objects.equal(
									_targetBlock, null));
							if (_notEquals_1) {
								TargetBlock _targetBlock_1 = s_1
										.getTargetBlock();
								CharSequence _print = this
										.print(_targetBlock_1);
								_builder.append(_print, "");
							}
						}
						_builder.newLineIfNotEmpty();
					...
					for (final BlockStatement s : _statements_1) {
						{
							...
							if (_notEquals) {
								SymbolDeclaration _symbol_1 = s.getSymbol();
								CharSequence _printDefaultEstimate = this
										.printDefaultEstimate(_symbol_1);
			...
			if (_notEquals) {
				...
				if (_notEquals_1) {
					CharSequence _xblockexpression = null;
					{
						...
						org.ddmore.mdl.mdl.List _list_1 = _expression_5
								.getList();
						...
						if (_notEquals_2) {
							...
							if (_greaterThan) {
								...
								EList<Argument> _arguments_1 = args
										.getArguments();
								Argument _get = _arguments_1.get(0);
								AnyExpression _expression_6 = _get
										.getExpression();
			...
			for (final BlockStatement s : _statements) {
				{
					...
					if (_notEquals) {
						SymbolDeclaration _symbol_1 = s.getSymbol();
						CharSequence _printCovariance = this
								.printCovariance(_symbol_1);
						_builder.append(_printCovariance, "");
					}
				}
			}
	...
	public String getTOL(final TaskObject obj) {
		...
		for (final TaskObjectBlock b : _blocks) {
			...
			if (_notEquals) {
				...
				EList<ModelBlockStatement> _statements = _modelBlock_1
						.getStatements();
		...
		StringConcatenation _builder = new StringConcatenation();
		{
			...
			if (_notEquals) {
				...
				}
				{
					...
					boolean _notEquals_3 = (!Objects
							.equal(_elseStatement, null));
					if (_notEquals_3) {
						_or = true;
					} else {
						Block _elseBlock = s.getElseBlock();
						boolean _notEquals_4 = (!Objects
								.equal(_elseBlock, null));
					...
					if (_or) {
						...
						_builder.newLine();
						{
							BlockStatement _elseStatement_1 = s
									.getElseStatement();
							boolean _notEquals_5 = (!Objects.equal(
									_elseStatement_1, null));
							if (_notEquals_5) {
								_builder.append("\t");
								BlockStatement _elseStatement_2 = s
										.getElseStatement();
								CharSequence _print_3 = this
										.print(_elseStatement_2);
								_builder.append(_print_3, "	");
								_builder.newLineIfNotEmpty();
							}
						}
						{
							...
							boolean _notEquals_6 = (!Objects.equal(
									_elseBlock_1, null));
							if (_notEquals_6) {
								_builder.append("\t");
								Block _elseBlock_2 = s.getElseBlock();
								CharSequence _print_4 = this
										.print(_elseBlock_2);
	...
	public String toStr(final org.ddmore.mdl.mdl.List l) {
		...
		if (_equals) {
			...
			if (_equals_1) {
				...
				String prediction = this.getAttribute(_arguments_3,
						"prediction");
	...
	public void prepareExternalFunctions(final ImportBlock b,
		...
		for (final ImportedFunction f : _functions) {
			{
				...
				if (_notEquals) {
					...
					if (_equals) {
						...
						Arguments _arguments_1 = _list_1.getArguments();
						EList<Argument> _arguments_2 = _arguments_1
								.getArguments();
						for (final Argument arg : _arguments_2) {
							String _identifier = arg.getIdentifier();
							boolean _notEquals_1 = (!Objects.equal(_identifier,
									null));
							if (_notEquals_1) {
	...
	public void prepareExternalCode(final TargetBlock b) {
		...
		if (_notEquals) {
			...
			if (_equals) {
				Arguments _arguments_1 = b.getArguments();
				final String location = this.getAttribute(_arguments_1,
						"location");
				Arguments _arguments_2 = b.getArguments();
				boolean _isAttributeTrue = this.isAttributeTrue(_arguments_2,
						"first");
				if (_isAttributeTrue) {
					ArrayList<String> codeSnippets = this.externalCodeStart
							.get(location);
					...
					ArrayList<String> codeSnippets_1 = this.externalCodeEnd
							.get(location);
