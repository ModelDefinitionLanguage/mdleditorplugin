...
class TestJSONParameterObjectToMDL extends ConverterTestsParent  {
	...
	private static final String structuralBlockJson_Warfarin =
		/ {"STRUCTURAL":[{"lo":"0.001","value":"0.1",".name":"POP_CL"},{"lo":"0.001","value":"8",".name":"POP_V"},{"lo":"0.001","value":"0.362",".name":"POP_KA"},{"lo":"0.001","value":"1","hi":"10",".name":"POP_TLAG"},{"fix":"true","value":"0.75",".name":"BETA_CL_WT"},{"fix":"true","value":"1",".name":"BETA_V_WT"}]} /
    ...
    private static final String variabilityBlockJson_WarfarinPkBov =
        / {"VARIABILITY":[{"BSV_CL":{"value":"0.1","type":"VAR"}},{"BSV_V":{"value":"0.1","type":"VAR"}},{"BOV_CL":{"fix":"true","value":"0.1","type":"VAR"}},{"BOV_V":{"fix":"true","value":"0.1","type":"VAR"}},{"BOV_COV_CL_V":{"fix":"true","value":"[0.01]","type":"COV"}},{"BSV_KA":{"value":"0.1","type":"VAR"}},{"BSV_TLAG":{"value":"0.1","type":"VAR"}},{"BOV_KA":{"value":"0.1","type":"VAR"}},{"BOV_TLAG":{"value":"0.1","type":"VAR"}},{"BOV_COV_KA_TLAG":{"value":"[0.01]","type":"COV"}},{"RUV_PROP":{"value":"0.01","type":"VAR"}},{"RUV_ADD":{"value":"0.05","type":"VAR"}}]} /
...
"""
    ...
    VARIABILITY {
        ...
        BOV_COV_CL_V : {fix=true, type=COV, value=[0.01]}
        BSV_KA : {type=VAR, value=0.1}
        BSV_TLAG : {type=VAR, value=0.1}
        BOV_KA : {type=VAR, value=0.1}
        BOV_TLAG : {type=VAR, value=0.1}
        BOV_COV_KA_TLAG : {type=COV, value=[0.01]}
        RUV_PROP : {type=VAR, value=0.01}
        RUV_ADD : {type=VAR, value=0.05}
    }
