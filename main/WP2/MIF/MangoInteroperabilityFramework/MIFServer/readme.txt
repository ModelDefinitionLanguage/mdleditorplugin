...
1.	Download the parent pom from http://svn.mango.local/svn/MangoRepository/MangoParentPom/
2.	Then install it into your local repository using this command “mvn install:install-file -DgroupId=com.mango.build -DartifactId=mango-parent-pom -Dpackaging=pom -Dversion=1.0 -Dfile=pom.xml”
