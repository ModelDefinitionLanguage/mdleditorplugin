...
class MatrixTypeInfoTest {
	val static String EXPECTED_TYPE_NAME = "matrix:Real"
	val static TypeInfoClass EXPECTED_TYPE_CLASS = TypeInfoClass.Matrix
	
	var MatrixTypeInfo testInstance
	var MatrixTypeInfo equivTestInstance
	var MatrixTypeInfo diffTestInstance 
	var MatrixTypeInfo diffCatTestInstance
	...
	@Before
	def void setUp(){
		testInstance = new MatrixTypeInfo(TypeSystemProvider::REAL_TYPE)
		equivTestInstance = new MatrixTypeInfo(TypeSystemProvider::REAL_TYPE)
		diffTestInstance = new MatrixTypeInfo(TypeSystemProvider::INT_TYPE)
		diffCatTestInstance = new MatrixTypeInfo(new GeneralCategoryTypeInfo)
		listType = new ListTypeInfo("Foo", new MatrixTypeInfo(TypeSystemProvider::REAL_TYPE))
