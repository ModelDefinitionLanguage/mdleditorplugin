...
class BuiltinEnumTypeInfoTest {
	...
	val static TypeInfoClass EXPECTED_TYPE_CLASS = TypeInfoClass.Builtin
	
	var BuiltinEnumTypeInfo testInstance
	var BuiltinEnumTypeInfo equivTestInstance
	var BuiltinEnumTypeInfo equivDiffCatsTestInstance
	var BuiltinEnumTypeInfo nonEquivTestInstance
	
	@Before
	def void setUp(){
		testInstance = new BuiltinEnumTypeInfo(TEST_NAME, TEST_CATAGS)
		equivTestInstance = new BuiltinEnumTypeInfo(TEST_NAME, TEST_CATAGS)
		this.nonEquivTestInstance = new BuiltinEnumTypeInfo("bar", TEST_CATAGS)
		equivDiffCatsTestInstance = new BuiltinEnumTypeInfo(TEST_NAME, TEST_ALT_CATAGS)
	}
